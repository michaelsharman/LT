import { c, k as a } from "./app-DV5bcV_K.js";
...
function d(e, t) {
  e && typeof e == "string" && (s.label = e), t && Array.isArray(t) && (s.types = t), s.renderedCss || u(), c().on("item:changed", p);
}
function p() {
  const e = question.questions();
  try {
    for (const t of e)
      if (s.types.includes("*") || s.types.includes(t.type)) {
        ...
        c().question(o).on("rendered", () => {
          ...
          if (n) {
            ...
            r || (i.append(f()), r = n.querySelector(`.${s.class}`), r.addEventListener("click", y));
          } else
