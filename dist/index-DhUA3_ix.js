import { c as a, f as i, z as d } from "./app-nM0lhDJq.js";
...
function p(e, t) {
  e && typeof e == "string" && (s.label = e), t && Array.isArray(t) && (s.types = t), s.renderedCss || (f(), s.renderedCss = !0), a().on("item:changed", u);
}
function u() {
  const e = i();
  try {
