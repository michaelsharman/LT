import { c as w, l as y } from "./app-C501rTFe.js";
const d = {
  renderedCss: !1,
  resize: {
    triggered: !1
...
function _() {
  d.renderedCss || L(), w().on("item:load", () => {
    v();
...
function k(e) {
  const r = (i) => {
    ...
    let s = !1, f = 0, u = 0;
    const b = (t) => {
      t instanceof MouseEvent ? u = t.clientX : u = t.targetTouches[0].clientX, f = o.getBoundingClientRect().width, s = !0, i.setAttribute("aria-pressed", "true"), document.addEventListener("mousemove", g), document.addEventListener("mouseup", p), document.addEventListener("touchmove", g), document.addEventListener("touchend", p);
    }, g = (t) => {
      if (!s)
        return;
      let l;
      t instanceof MouseEvent ? l = t.clientX - u : l = t.targetTouches[0].clientX - u;
      const m = c.getBoundingClientRect().width, a = (f + l) * 100 / m;
      a >= 10 && a <= 90 && (o.style.width = a + "%");
    }, p = () => {
      s = !1, i.setAttribute("aria-pressed", "false"), document.removeEventListener("mousemove", g), document.removeEventListener("mouseup", p), document.removeEventListener("touchmove", g), document.removeEventListener("touchend", p);
    }, x = (t) => {
      if ((t.key === " " || t.key === "Spacebar") && (t.preventDefault(), s = !s, i.setAttribute("aria-pressed", String(s))), !s)
        return;
      const l = 2, m = c.getBoundingClientRect().width, a = o.getBoundingClientRect().width * 100 / m;
      if (t.key === "ArrowLeft") {
        t.preventDefault();
        const h = Math.max(10, a - l);
        o.style.width = h + "%";
      }
      if (t.key === "ArrowRight") {
        t.preventDefault();
        const h = Math.min(90, a + l);
        o.style.width = h + "%";
      }
    };
    i.addEventListener("mousedown", b), i.addEventListener("touchstart", b), i.addEventListener("keydown", x);
...
function E(e, r) {
  d.resize.triggered || (d.resize.triggered = !0, e.apply(this));
  let n;
  return (...i) => {
    clearTimeout(n), n = setTimeout(() => {
      d.resize.triggered = !1, e.apply(this, i);
    }, r);
  };
}
function L() {
...
.lt__resizer-tab:focus {
  background-color: rgba(0, 123, 255, 0.2); /* Light focus indicator */
  box-shadow: 0 0 0 2px rgba(0, 123, 255, 0.6); /* For keyboard users */
}

.lt__resizer-tab:hover {
  background-color: rgba(0, 0, 0, 0.05);
}

.lt__resizer-tab.is-resizing,
...
/* Internal tab styling (the grip icon) */
.lt__resizer-tab {
  display: flex;
  align-items: center;
  justify-content: center;
  pointer-events: none; /* Allows full drag area */
}
...
`;
  e.setAttribute("data-style", "LT Column Resizer"), e.textContent = r, document.head.append(e), d.renderedCss = !0;
}
