import { c as m } from "./extensionsFactory-DRAOPv5d.js";
const g = {
  renderedCss: !1
};
function h() {
  g.renderedCss || (k(), g.renderedCss = !0);
}
function b(t, o) {
  const e = v(), d = LRNCKEDITOR.currentInstance.getSelectedHtml().getHtml(), l = LRNCKEDITOR.currentInstance.getData(), i = f();
  ...
  document.querySelector("#ltLanguageModal .lrn-qe-btn-primary").addEventListener("click", () => {
    const n = y(d), a = {};
    document.getElementById("ltLanguageModal").remove(), r.selectedIndex > 0 && (a.direction = r.options[r.selectedIndex].getAttribute("data-dir"), a.code = r.options[r.selectedIndex].value), u.checked && (a.noTranslate = !0);
    const p = q(a, n, d, l);
    return o(p);
  });
}
...
function q(t, o, e, d) {
  let l = "", i = "";
  if (t?.code && (l += ` lang="${t.code}" dir="${t.direction}"`), t?.noTranslate && (l += ' translate="no"'), o === "block")
    switch (s(e)) {
...
function s(t) {
  const o = /<p>.*?<\/p>/gs, e = t.match(o);
  return e ? e.length : 0;
}
function y(t) {
  return s(t) <= 1 ? "inline" : "block";
}
function k() {
  const t = document.createElement("style"), o = `
...
`;
  t.setAttribute("data-style", "LT Language Text Direction"), t.textContent = o, document.head.append(t), g.renderedCss = !0;
}
const _ = m("languageTextDirection", h, {
  addLanguageAttribute: b
}), C = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  languageTextDirection: _
