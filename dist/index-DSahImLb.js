...
function p() {
  ...
  if (t.length === 2) {
    if (!n && !r) {
      ...
      o.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-grip-vertical-icon lucide-grip-vertical"><circle cx="9" cy="12" r="1"/><circle cx="9" cy="5" r="1"/><circle cx="9" cy="19" r="1"/><circle cx="15" cy="12" r="1"/><circle cx="15" cy="5" r="1"/><circle cx="15" cy="19" r="1"/></svg>', i.classList.add("lt__resizer"), t[0].classList.add("lrn-column-left"), t[1].classList.add("lrn-column-right"), i.append(o), t[0].after(i);
    } else n && r && x(e, t);
    y(e);
  }
}
