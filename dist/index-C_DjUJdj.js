import { c as j, n as ie, D as G, f as U, l as ae, E as se } from "./app-DrpANbC0.js";
import { g as ce } from "./_commonjsHelpers-ByX85dGu.js";
import { c as fe } from "./moduleFactory-Ck7axszi.js";
function ue(m, a) {
  ...
  return Q || (Q = 1, function(m, a) {
    (function(i, s) {
      ...
      function i(o, _) {
        ...
        return P.addListener(C), function() {
          return P.removeListener(C);
        };
      }
      function s(o, _) {
      ...
      var x = !g, u = g ? navigator.userAgent : void 0, e = { gui: g, terminal: x, registerQuery: i };
      ...
      if (e.gui) {
        ...
        if (window.addEventListener("gamepadconnected", function(o) {
          ...
          e.touch = navigator.maxTouchPoints > 0, e.tv = u.includes("TV"), M = navigator.getGamepads ? Array.from(navigator.getGamepads()).filter(function(o) {
            return o != null;
          }).length : 0, e.gamepad = M > 0, i("(orientation: portrait)", function(o) {
...
var Y = de();
const pe = /* @__PURE__ */ ce(Y), me = /* @__PURE__ */ ue({
  __proto__: null,
  default: pe
}, [Y]);
var F = { exports: {} }, X;
  ...
  return X || (X = 1, function(m) {
    (function(a, i, s) {
      ...
      function b(t) {
        ...
        function V(n, l, p, f, h, E) {
          var d, w, T = [], A = p.type;
          if (!r._callbacks[n])
            return [];
          for (A == "keyup" && C(n) && (l = [n]), d = 0; d < r._callbacks[n].length; ++d)
            if (w = r._callbacks[n][d], !(!f && w.seq && c[w.seq] != w.level) && A == w.action && (A == "keypress" && !p.metaKey && !p.ctrlKey || L(l, w.modifiers))) {
        ...
        function R(n, l, p, f) {
          r.stopCallback(l, l.target || l.srcElement, p, f) || n(l, p) === !1 && (_(l), P(l));
        }
        r._handleKey = function(n, l, p) {
          var f = V(n, l, p), h, E = {}, d = 0, w = !1;
        ...
        function re(n, l, p, f) {
          ...
          for (var d = 0; d < l.length; ++d) {
            var w = d + 1 === l.length, T = w ? E : h(f || z(l[d + 1]).action);
            H(l[d], T, f, n, d);
          }
        }
        function H(n, l, p, f, h) {
        ...
        r._bindMultiple = function(n, l, p) {
          for (var f = 0; f < n.length; ++f)
            H(n[f], l, p);
        }, M(t, "keypress", W), M(t, "keydown", W), M(t, "keyup", W);
      }
...
function ve(m = we()) {
  const a = be();
  O.bindings = m, a && (ke(), O.bindings.hasOwnProperty("global") && Array.isArray(O.bindings.global) && O.bindings.global.forEach((i) => {
  ...
  a.forEach((s) => {
    ...
    s.type === "mcq" && K.bind(m, (g, x) => {
      if (G()) {
        ...
        if (s.options?.length >= u) {
          const y = ae().querySelectorAll(".lrn-mcq-option")[u - 1].querySelector(".lrn-mask");
          y && y.click();
        }
      }
    });
...
const Me = fe("keyboardShortcuts", ve), Oe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  keyboardShortcuts: Me
