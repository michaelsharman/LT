import { a as Ps } from "./app-BXKmoa_A.js";
import { c as Cs } from "./styling-CgOepzZE.js";
...
function bo(i, e, t, r, a, o, s, n, p, l, c) {
  ...
  for (p = Ms(t, e, w, p, x), d = 0; d < x; d++) (m = t.__k[d]) != null && (h = m.__i == -1 ? it : w[m.__i] || it, m.__i = d, b = Vi(i, m, h, a, o, s, n, p, l, c), f = m.__e, m.ref && h.ref != m.ref && (h.ref && Gi(h.ref, null, m), c.push(m.ref, m.__c || f, m)), y == null && f != null && (y = f), 4 & m.__u || h.__k === m.__k ? p = vo(m, p, i) : typeof m.type == "function" && b !== void 0 ? p = b : f && (p = f.nextSibling), m.__u &= -7);
  return t.__e = y, p;
}
...
var at, $, jt, Dr, ot = 0, ko = [], L = P, kr = L.__b, Sr = L.__r, Pr = L.diffed, Cr = L.__c, Br = L.unmount, Ir = L.__;
function Xi(i, e) {
...
L.__b = function(i) {
  ...
  Sr && Sr(i), at = 0;
  var e = ($ = i.__c).__H;
  e && (jt === $ ? (e.__h = [], $.__h = [], e.__.forEach(function(t) {
    t.__N && (t.__ = t.__N), t.u = t.__N = void 0;
  })) : (e.__h.forEach(Tt), e.__h.forEach(Ci), e.__h = [], at = 0)), jt = $;
}, L.diffed = function(i) {
  Pr && Pr(i);
  var e = i.__c;
  e && e.__H && (e.__H.__h.length && (ko.push(e) !== 1 && Dr === L.requestAnimationFrame || ((Dr = L.requestAnimationFrame) || Hs)(js)), e.__H.__.forEach(function(t) {
...
P.unmount = function(i) {
...
}, (Ht.prototype = new X()).__c = function(i, e) {
  var t = e.__c, r = this;
  ...
  this.o = [];
}, Ht.prototype.render = function(i, e) {
  if (this.__b) {
    if (this.__v.__k) {
...
const an = "@uppy/store-default", on = "The default simple object-based store for Uppy.", sn = "4.3.1", nn = "MIT", ln = "lib/index.js", pn = "module", dn = { build: "tsc --build tsconfig.build.json", typecheck: "tsc --build", test: "vitest run --environment=jsdom --silent='passed-only'" }, un = ["file uploader", "uppy", "uppy-store"], cn = "https://uppy.io", hn = { url: "https://github.com/transloadit/uppy/issues" }, fn = { jsdom: "^26.1.0", typescript: "^5.8.3", vitest: "^3.2.4" }, mn = { type: "git", url: "git+https://github.com/transloadit/uppy.git" }, gn = {
  name: an,
  description: on,
  version: sn,
  license: nn,
...
function jr(i) {
  let e = "";
  return i.replace(/[^A-Z0-9]/gi, (t) => (e += `-${bn(t)}`, "/")) + e;
}
function vn(i, e) {
  let t = e || "uppy";
...
function To() {
  if (Wr) return Vt;
  Wr = 1;
  var i = _n(), e = typeof self == "object" && self && self.Object === Object && self, t = i || e || Function("return this")();
  return Vt = t, Vt;
}
var Gt, Vr;
function Dn() {
...
function Bn() {
  if (Qr) return Jt;
  Qr = 1;
  var i = Eo(), e = Pn(), t = Cn(), r = "[object Null]", a = "[object Undefined]", o = i ? i.toStringTag : void 0;
  function s(n) {
...
function Tn() {
  if (ta) return ii;
  ta = 1;
  var i = Sn(), e = Ki(), t = Fn(), r = NaN, a = /^[-+]0x[0-9a-f]+$/i, o = /^0b[01]+$/i, s = /^0o[0-7]+$/i, n = parseInt;
  function p(l) {
    if (typeof l == "number")
      return l;
    if (t(l))
...
function Ao() {
  if (ia) return ri;
  ia = 1;
  var i = Ki(), e = Dn(), t = Tn(), r = "Expected a function", a = Math.max, o = Math.min;
  function s(n, p, l) {
...
let Nn = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", Zi = (i = 21) => {
  let e = "", t = i | 0;
  for (; t--; )
    e += Nn[Math.random() * 64 | 0];
  return e;
};
const Un = "@uppy/core", $n = "Core module for the extensible JavaScript file upload widget with support for drag&drop, resumable uploads, previews, restrictions, file processing/encoding, remote providers like Instagram, Dropbox, Google Drive, S3 and more :dog:", Ln = "4.5.1", jn = "MIT", Hn = "lib/index.js", qn = "dist/style.min.css", Wn = "module", Vn = ["*.css"], Gn = { build: "tsc --build tsconfig.build.json", "build:css": "sass --load-path=../../ src/style.scss dist/style.css && postcss dist/style.css -u cssnano -o dist/style.min.css", typecheck: "tsc --build", test: "vitest run --environment=jsdom --silent='passed-only'" }, Xn = ["file uploader", "uppy", "uppy-plugin"], Yn = "https://uppy.io", Kn = { url: "https://github.com/transloadit/uppy/issues" }, Zn = { type: "git", url: "git+https://github.com/transloadit/uppy.git" }, Qn = { "@transloadit/prettier-bytes": "^0.3.4", "@uppy/store-default": "^4.3.1", "@uppy/utils": "^6.2.1", lodash: "^4.17.21", "mime-match": "^1.0.2", "namespace-emitter": "^2.0.1", nanoid: "^5.0.9", preact: "^10.5.13" }, Jn = { "@types/deep-freeze": "^0", cssnano: "^7.0.7", "deep-freeze": "^0.0.1", jsdom: "^26.1.0", postcss: "^8.5.6", "postcss-cli": "^11.0.1", sass: "^1.89.2", typescript: "^5.8.3", vitest: "^3.2.4" }, el = {
  name: Un,
  description: $n,
  version: Ln,
  license: jn,
...
class dl {
  ...
  validateSingleFile(e) {
    ...
    if (a && !a.some((s) => s.includes("/") ? e.type ? ll(e.type.replace(/;.*?$/, ""), s) : !1 : s[0] === "." && e.extension ? e.extension.toLowerCase() === s.slice(1).toLowerCase() : !1)) {
      const s = a.join(", ");
...
class Qi {
  ...
  constructor(e) {
    ...
    this.opts = {
      ...
      meta: { ...this.opts.meta },
      info: []
    }), this.#t = new dl(() => this.opts, () => this.i18n), this.#r = this.store.subscribe((a, o, s) => {
  ...
  #c(e) {
    const t = e instanceof File ? {
      ...
      size: e.size,
      data: e
    } : e, r = Fo(t), a = tl(r, t), o = Ot(a).extension, s = xn(t, this.getID()), n = t.meta || {};
    n.name = a, n.type = r;
 ...
 * ${p.message}`;
 ...
 type: ${n.type}`);
  ...
  #y = On(() => this.#_(), 500, { leading: !0, trailing: !0 });
...
function u(i, e, t, r, a, o) {
  ...
  var l = { type: i, props: p, key: t, ref: s, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --cl, __i: -1, __u: 0, __source: a, __self: o };
  if (typeof i == "function" && (s = i.defaultProps)) for (n in s) p[n] === void 0 && (p[n] = s[n]);
  return P.vnode && P.vnode(l), l;
}
const hl = "@uppy/informer", fl = "A notification and error pop-up bar for Uppy.", ml = "4.3.1", gl = "MIT", yl = "lib/index.js", bl = "dist/style.min.css", vl = "module", wl = { build: "tsc --build tsconfig.build.json", "build:css": "sass --load-path=../../ src/style.scss dist/style.css && postcss dist/style.css -u cssnano -o dist/style.min.css", typecheck: "tsc --build" }, xl = ["file uploader", "uppy", "uppy-plugin", "notification", "bar", "ui"], _l = "https://uppy.io", Dl = { url: "https://github.com/transloadit/uppy/issues" }, kl = { type: "git", url: "git+https://github.com/transloadit/uppy.git" }, Sl = { "@uppy/utils": "^6.2.1", preact: "^10.5.13" }, Pl = { "@uppy/core": "^4.5.1" }, Cl = { cssnano: "^7.0.7", postcss: "^8.5.6", "postcss-cli": "^11.0.1", sass: "^1.89.2", typescript: "^5.8.3" }, Bl = {
  name: hl,
  description: fl,
  version: ml,
  license: gl,
...
class Oo extends X {
  ...
  _handleDoneLeaving(e) {
    ...
    if (a && Object.hasOwn(a, e))
      ...
      const o = Fl({}, this.state.children);
...
class Ml extends ve {
  static VERSION = Bl.version;
  constructor(e, t) {
    super(e, t), this.type = "progressindicator", this.id = this.opts.id || "Informer", this.title = "Informer";
  }
  render = (e) => u("div", { className: "uppy uppy-Informer", children: u(Oo, { children: e.info.map((t) => u(Il, { children: u("p", { role: "alert", children: [t.message, " ", t.details && // biome-ignore lint/a11y/useKeyWithClickEvents: ...
...
class $l extends X {
  ...
  render({ data: e, rowHeight: t, renderRow: r, overscanCount: a = 10, ...o }) {
    ...
    const c = p + l + 4, d = e.slice(p, c), h = { ...Nl, height: e.length * t }, m = { ...Ul, top: p * t };
...
const jl = "@uppy/status-bar", Hl = "A progress bar for Uppy, with many bells and whistles.", ql = "4.2.1", Wl = "MIT", Vl = "lib/index.js", Gl = "dist/style.min.css", Xl = "module", Yl = { build: "tsc --build tsconfig.build.json", "build:css": "sass --load-path=../../ src/style.scss dist/style.css && postcss dist/style.css -u cssnano -o dist/style.min.css", typecheck: "tsc --build" }, Kl = ["file uploader", "uppy", "uppy-plugin", "progress bar", "status bar", "progress", "upload", "eta", "speed"], Zl = "https://uppy.io", Ql = { url: "https://github.com/transloadit/uppy/issues" }, Jl = { type: "git", url: "git+https://github.com/transloadit/uppy.git" }, ep = { "@transloadit/prettier-bytes": "^0.3.4", "@uppy/utils": "^6.2.1", classnames: "^2.2.6", preact: "^10.5.13" }, tp = { "@uppy/core": "^4.5.1" }, ip = { cssnano: "^7.0.7", postcss: "^8.5.6", "postcss-cli": "^11.0.1", sass: "^1.89.2", typescript: "^5.8.3" }, rp = {
  name: jl,
  description: Hl,
  version: ql,
  license: Wl,
...
function sp(i) {
  const e = op(i), t = e.hours === 0 ? "" : `${e.hours}h`, r = e.minutes === 0 ? "" : `${e.hours === 0 ? e.minutes : ` ${e.minutes.toString(10).padStart(2, "0")}`}m`, a = e.hours !== 0 ? "" : `${e.minutes === 0 ? e.seconds : ` ${e.seconds.toString(10).padStart(2, "0")}`}s`;
  return `${t}${r}${a}`;
}
const np = "·", ua = () => ` ${np} `;
function lp(i) {
...
function gp(i) {
  ...
  function w() {
    return !n && !y && a ? t ? u(fp, { numUploads: l, complete: c, totalUploadedSize: d, totalSize: h, totalETA: m, i18n: e }) : u(zo, { i18n: e, complete: c, numUploads: l }) : null;
  }
  return u("div", { className: "uppy-StatusBar-content", title: b, children: [n ? null : u(Mo, {}), u("div", { className: "uppy-StatusBar-status", children: [u("div", { className: "uppy-StatusBar-statusPrimary", children: t && r !== 0 ? `${b}: ${r}%` : b }), w(), y ? u(mp, { i18n: e, newFiles: p, startUpload: f }) : null] })] });
}
function yp(i) {
  const { i18n: e } = i;
  return u("div", {
...
function wp({ newFiles: i, allowNewUpload: e, isUploadInProgress: t, isAllPaused: r, resumableUploads: a, error: o, hideUploadButton: s = void 0, hidePauseResumeButton: n = !1, hideCancelButton: p = !1, hideRetryButton: l = !1, recoveredState: c, uploadState: d, totalProgress: h, files: m, supportsUploadProgress: f, hideAfterFinish: y = !1, isSomeGhost: b, doneButtonHandler: w = void 0, isUploadStarted: x, i18n: _, startUpload: C, uppy: B, isAllComplete: g, showProgressDetails: D = void 0, numUploads: k, complete: S, totalSize: O, totalETA: T, totalUploadedSize: M }) {
  ...
  const A = F(), V = A ?? 100, oe = !o && i && (!t && !r || c) && e && !s, ue = !p && d !== vp && d !== bt, he = a && !n && d === yt, xe = o && !g && !l, _e = w && d === bt, Fe = ae("uppy-StatusBar-progress", {
    "is-indeterminate": z()
  }), fe = ae("uppy-StatusBar", `is-${d}`, { "has-ghosts": b }), De = (() => {
    switch (d) {
      case ui:
      case ci:
        return u(hp, { progress: di(m) });
      case bt:
        return u(yp, { i18n: _ });
      case ca:
        return u(bp, { error: o, i18n: _, numUploads: k, complete: S });
      case yt:
        return u(gp, { i18n: _, supportsUploadProgress: f, totalProgress: h, showProgressDetails: D, isUploadStarted: x, isAllComplete: g, isAllPaused: r, newFiles: i, numUploads: k, complete: S, totalUploadedSize: M, totalSize: O, totalETA: T, startUpload: C });
      default:
        return null;
    }
  })();
  return !(oe || xe || he || ue || _e) && !De || d === bt && y ? null : u("div", { className: fe, children: [u("div", { className: Fe, style: { width: `${V}%` }, role: "progressbar", "aria-label": `${V}%`, "aria-valuetext": `${V}%`, "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": A }), De, u("div", { className: "uppy-StatusBar-actions", children: [oe ? u(lp, { newFiles: i, isUploadStarted: x, recoveredState: c, i18n: _, isSomeGhost: b, startUpload: C, uploadState: d }) : null, xe ? u(pp, { i18n: _, uppy: B }) : null, he ? u(up, { isAllPaused: r, i18n: _, isAllComplete: g, resumableUploads: a, uppy: B }) : null, ue ? u(dp, { i18n: _, uppy: B }) : null, _e ? u(cp, { i18n: _, doneButtonHandler: w }) : null] })] });
}
const xp = 2e3, _p = 2e3;
function Dp(i, e, t, r) {
  if (i)
...
class Sp extends ve {
  static VERSION = rp.version;
  #e;
  #t;
  #r;
  #i;
  constructor(e, t) {
    super(e, { ...kp, ...t }), this.id = this.opts.id || "StatusBar", this.title = "StatusBar", this.type = "progressindicator", this.defaultLocale = ap, this.i18nInit(), this.render = this.render.bind(this), this.install = this.install.bind(this);
  }
  #a(e) {
    ...
    if (this.#t = e.uploaded, a <= 0)
      return Math.round((this.#i ?? 0) / 100) / 10;
    const o = a / r, s = this.#r == null ? o : da(o, this.#r, xp, r);
    this.#r = s;
    const n = t / s, p = Math.max(this.#i - r, 0), l = this.#i == null ? n : da(n, p, _p, r);
...
const Pp = /^data:([^/]+\/[^,;]+(?:[^,]*?))(;base64)?,([\s\S]*)$/;
function Cp(i, e, t) {
  const r = Pp.exec(i), a = e.mimeType ?? r?.[1] ?? "plain/text";
  let o;
  if (r?.[2] != null) {
...
const st = typeof navigator < "u", Bp = st && typeof HTMLImageElement > "u", ma = !(typeof global > "u" || typeof process > "u" || !process.versions || !process.versions.node), No = Ro.Buffer, Uo = !!No, Ip = (i) => i !== void 0;
function $o(i) {
  return i === void 0 || (i instanceof Map ? i.size === 0 : Object.values(i).filter(Ip).length === 0);
}
function W(i) {
  let e = new Error(i);
...
const va = (i) => Fp(i).then((e) => e.arrayBuffer()), Ti = (i) => new Promise((e, t) => {
  let r = new FileReader();
  r.onloadend = () => e(r.result || new ArrayBuffer()), r.onerror = t, r.readAsArrayBuffer(i);
}), tr = /* @__PURE__ */ new Map(), Tp = /* @__PURE__ */ new Map(), Ep = /* @__PURE__ */ new Map(), vt = ["chunked", "firstChunkSize", "firstChunkSizeNode", "firstChunkSizeBrowser", "chunkSize", "chunkLimit"], jo = ["jfif", "xmp", "icc", "iptc", "ihdr"], Ei = ["tiff", ...jo], H = ["ifd0", "ifd1", "exif", "gps", "interop"], wt = [...Ei, ...H], xt = ["makerNote", "userComment"], Ho = ["translateKeys", "translateValues", "reviveValues", "multiSegment"], _t = [...Ho, "sanitize", "mergeOutput", "silentErrors"];
class qo {
  get translate() {
...
class We extends qo {
  ...
  constructor(e, t, r, a) {
    if (super(), E(this, "enabled", !1), E(this, "skip", /* @__PURE__ */ new Set()), E(this, "pick", /* @__PURE__ */ new Set()), E(this, "deps", /* @__PURE__ */ new Set()), E(this, "translateKeys", !1), E(this, "translateValues", !1), E(this, "reviveValues", !1), this.key = e, this.enabled = t, this.parse = this.enabled, this.applyInheritables(a), this.canBeFiltered = H.includes(e), this.canBeFiltered && (this.dict = tr.get(e)), r !== void 0) if (Array.isArray(r)) this.parse = this.enabled = !0, this.canBeFiltered && r.length > 0 && this.translateTagSet(r, this.pick);
  ...
  applyInheritables(e) {
    let t, r;
    for (t of Ho) r = e[t], r !== void 0 && (this[t] = r);
  }
  translateTagSet(e, t) {
    if (this.dict) {
...
class ir extends qo {
  ...
  setupFromObject(e) {
    let t;
    for (t of (H.ifd0 = H.ifd0 || H.image, H.ifd1 = H.ifd1 || H.thumbnail, Object.assign(this, e), vt)) this[t] = fi(e[t], G[t]);
    for (t of _t) this[t] = fi(e[t], G[t]);
    for (t of xt) this[t] = fi(e[t], G[t]);
    for (t of Ei) this[t] = new We(t, G[t], e[t], this);
    for (t of H) this[t] = new We(t, G[t], e[t], this.tiff);
    this.setupGlobalFilters(e.pick, e.skip, H, wt), e.tiff === !0 ? this.batchEnableWithBool(H, !0) : e.tiff === !1 ? this.batchEnableWithUserValue(H, e) : Array.isArray(e.tiff) ? this.setupGlobalFilters(e.tiff, void 0, H) : typeof e.tiff == "object" && this.setupGlobalFilters(e.tiff.pick, e.tiff.skip, H);
  }
  ...
  traverseTiffDependencyTree() {
    ...
    a.needed && (t.deps.add(40965), e.deps.add(40965)), t.needed && e.deps.add(34665), r.needed && e.deps.add(34853), this.tiff.enabled = H.some((o) => this[o].enabled === !0) || this.makerNote || this.userComment;
    for (let o of H) this[o].finalizeFilters();
  }
  get onlyTiff() {
    return !jo.map((e) => this[e].enabled).some((e) => e === !0) && this.tiff.enabled;
  }
  checkLoadedPlugins() {
...
class Ap {
  ...
  async read(e) {
    this.file = await function(t, r) {
      return typeof t == "string" ? ba(t, r) : st && !Bp && t instanceof HTMLImageElement ? ba(t.src, r) : t instanceof Uint8Array || t instanceof ArrayBuffer || t instanceof DataView ? new ie(t) : st && t instanceof Blob ? Ii(t, r, "blob", Ti) : void W("Invalid input argument");
    }(e, this.options);
  }
  setup() {
...
class Oe {
  ...
  translateBlock(e, t) {
    let r = Ep.get(t), a = Tp.get(t), o = tr.get(t), s = this.options[t], n = s.reviveValues && !!r, p = s.translateValues && !!a, l = s.translateKeys && !!o, c = {};
...
class _a extends class {
  ...
  findAppSegmentsInRange(e, t) {
    ...
    for (; e < t; e++) if (l.getUint8(e) === 255) {
      if (r = l.getUint8(e + 1), Mp(r)) {
        if (a = l.getUint16(e + 2), o = zp(l, e, a), o && d.has(o) && (s = ee.get(o), n = s.findPosition(l, e), p = m[o], n.type = o, this.appSegments.push(n), !c && (s.multiSegment && p.multiSegment ? (this.unfinishedMultiSegment = n.chunkNumber < n.chunkCount, this.unfinishedMultiSegment || h.delete(o)) : h.delete(o), h.size === 0))) break;
...
const Rp = [void 0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8, 4];
class Np extends Oe {
  parseHeader() {
  ...
  parseTag(e, t, r) {
    let { chunk: a } = this, o = a.getUint16(e + 2), s = a.getUint32(e + 4), n = Rp[o];
...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e.byteLength}`), e.tiff && await e.ensureChunk(this.ifd0Offset, ga(this.options));
  ...
  createOutput() {
    let e, t, r, a = {};
    for (t of H) if (e = this[t], !$o(e)) if (r = this.canTranslate ? this.translateBlock(e, t) : Object.fromEntries(e), this.options.mergeOutput) {
      if (t === "ifd1") continue;
      Object.assign(a, r);
    } else a[t] = r;
...
const Up = Object.assign({}, rr, { firstChunkSize: 4e4, ifd0: [274] });
async function $p(i) {
  let e = new Ap(Up);
  await e.read(i);
  let t = await e.parse();
...
const Lp = Object.freeze({ 1: { dimensionSwapped: !1, scaleX: 1, scaleY: 1, deg: 0, rad: 0 }, 2: { dimensionSwapped: !1, scaleX: -1, scaleY: 1, deg: 0, rad: 0 }, 3: { dimensionSwapped: !1, scaleX: 1, scaleY: 1, deg: 180, rad: 180 * Math.PI / 180 }, 4: { dimensionSwapped: !1, scaleX: -1, scaleY: 1, deg: 180, rad: 180 * Math.PI / 180 }, 5: { dimensionSwapped: !0, scaleX: 1, scaleY: -1, deg: 90, rad: 90 * Math.PI / 180 }, 6: { dimensionSwapped: !0, scaleX: 1, scaleY: 1, deg: 90, rad: 90 * Math.PI / 180 }, 7: { dimensionSwapped: !0, scaleX: 1, scaleY: -1, deg: 270, rad: 270 * Math.PI / 180 }, 8: { dimensionSwapped: !0, scaleX: 1, scaleY: 1, deg: 270, rad: 270 * Math.PI / 180 } });
let Ze = !0, Qe = !0;
...
async function jp(i) {
  let e = await $p(i);
  return Object.assign({ canvas: Ze, css: Qe }, Lp[e]);
}
class Hp extends ie {
  constructor(...e) {
    super(...e), E(this, "ranges", new qp()), this.byteLength !== 0 && this.ranges.add(0, this.byteLength);
  }
  _tryExtend(e, t, r) {
...
const Vp = "@uppy/thumbnail-generator", Gp = "Uppy plugin that generates small previews of images to show on your upload UI.", Xp = "4.2.1", Yp = "MIT", Kp = "lib/index.js", Zp = "module", Qp = { build: "tsc --build tsconfig.build.json", typecheck: "tsc --build", test: "vitest run --environment=jsdom --silent='passed-only'" }, Jp = ["file uploader", "uppy", "uppy-plugin", "thumbnail", "preview", "resize"], ed = "https://uppy.io", td = { url: "https://github.com/transloadit/uppy/issues" }, id = { type: "git", url: "git+https://github.com/transloadit/uppy.git" }, rd = { "@uppy/utils": "^6.2.1", exifr: "^7.0.0" }, ad = { jsdom: "^26.1.0", "namespace-emitter": "2.0.1", typescript: "^5.8.3", vitest: "^3.2.4" }, od = { "@uppy/core": "^4.5.1" }, sd = {
  name: Vp,
  description: Gp,
  version: Xp,
  license: Yp,
...
function ld(i, e, t) {
  ...
  return i.toBlob ? new Promise((r) => {
    ...
    return r;
  }) : Promise.resolve().then(() => Cp(i.toDataURL(e, t), {})).then((r) => {
    if (r === null)
...
class cd extends ve {
  ...
  thumbnailType;
  constructor(e, t) {
    if (super(e, { ...ud, ...t }), this.type = "modifier", this.id = this.opts.id || "ThumbnailGenerator", this.title = "Thumbnail Generator", this.queue = [], this.queueProcessing = !1, this.defaultThumbnailDimension = 200, this.thumbnailType = this.opts.thumbnailType, this.defaultLocale = nd, this.i18nInit(), this.opts.lazy && this.opts.waitForThumbnailsBeforeUpload)
  ...
  createThumbnail(e, t, r) {
    ...
    return Promise.all([o, s]).then(([n, p]) => {
      const l = this.getProportionalDimensions(n, t, r, p.deg), c = pd(n, p), d = this.resizeImage(c, l.width, l.height);
      return ld(d, this.thumbnailType, 80);
   ...
   */
  resizeImage(e, t, r) {
    let a = dd(e), o = Math.ceil(Math.log2(a.width / t));
    o < 1 && (o = 1);
...
const gd = "@uppy/dashboard", yd = "Universal UI plugin for Uppy.", bd = "4.4.1", vd = "MIT", wd = "lib/index.js", xd = "dist/style.min.css", _d = "module", Dd = { build: "tsc --build tsconfig.build.json", "build:css": "sass --load-path=../../ src/style.scss dist/style.css && postcss dist/style.css -u cssnano -o dist/style.min.css", typecheck: "tsc --build", test: "vitest run --silent='passed-only'", "test:e2e": "vitest watch --project browser --browser.headless false" }, kd = ["file uploader", "uppy", "uppy-plugin", "dashboard", "ui"], Sd = "https://uppy.io", Pd = { url: "https://github.com/transloadit/uppy/issues" }, Cd = { type: "git", url: "git+https://github.com/transloadit/uppy.git" }, Bd = { "@transloadit/prettier-bytes": "^0.3.4", "@uppy/informer": "^4.3.1", "@uppy/provider-views": "^4.5.1", "@uppy/status-bar": "^4.2.1", "@uppy/thumbnail-generator": "^4.2.1", "@uppy/utils": "^6.2.1", classnames: "^2.2.6", lodash: "^4.17.21", nanoid: "^5.0.9", preact: "^10.5.13", "shallow-equal": "^3.0.0" }, Id = { "@uppy/core": "^4.5.1", "@uppy/google-drive": "^4.4.1", "@uppy/status-bar": "^4.2.1", "@uppy/url": "^4.3.1", "@uppy/webcam": "^4.3.1", "@vitest/browser": "^3.2.4", cssnano: "^7.0.7", jsdom: "^26.1.0", postcss: "^8.5.6", "postcss-cli": "^11.0.1", "resize-observer-polyfill": "^1.5.0", sass: "^1.89.2", typescript: "^5.8.3", vitest: "^3.2.4" }, Fd = { "@uppy/core": "^4.5.1" }, Td = {
  name: gd,
  description: yd,
  version: bd,
  license: vd,
...
const Ad = (i) => u("div", { className: ae("uppy-Dashboard-AddFilesPanel", i.className), "data-uppy-panelType": "AddFiles", "aria-hidden": !i.showAddFilesPanel, children: [u("div", { className: "uppy-DashboardContent-bar", children: [u("div", {
...
function Hd(i) {
  ...
  u("div", { className: ae("uppy-Dashboard-FileCard", c), "data-uppy-panelType": "FileCard", onDragOver: ge, onDragLeave: ge, onDrop: ge, onPaste: ge, children: [u("div", { className: "uppy-DashboardContent-bar", children: [u("div", {
    ...
    _(D), n(m);
  }, children: p("editImage") })] }), u("div", { className: "uppy-Dashboard-FileCard-info", children: u(jd, { computedMetaFields: f, requiredMetaFields: s, updateMeta: C, form: g, formState: w }) }), u("div", { className: "uppy-Dashboard-FileCard-actions", children: [u("button", {
...
function Wd(i, e = "Copy the URL below") {
...
function Vd({ file: i, uploadInProgressOrComplete: e, metaFields: t, canEditFile: r, i18n: a, onClick: o }) {
...
function Gd({ i18n: i, onClick: e, file: t }) {
...
function Xd({ file: i, uppy: e, i18n: t }) {
  const r = (a) => {
    Wd(i.uploadURL, t("copyLinkToClipboardFallback")).then(() => {
...
function Yd(i) {
  ...
  return u("div", { className: "uppy-Dashboard-Item-actionWrapper", children: [u(Vd, { i18n: p, file: t, uploadInProgressOrComplete: r, canEditFile: a, metaFields: o, onClick: () => {
    o && o.length > 0 ? l(!0, t.id) : c(t);
  } }), s && t.uploadURL ? u(Xd, { file: t, uppy: e, i18n: p }) : null, n ? u(Gd, { i18n: p, file: t, onClick: () => e.removeFile(t.id) }) : null] });
}
const gi = "...";
function Ko(i, e) {
  if (e === 0)
...
const Kd = (i, e) => (typeof e == "function" ? e() : e).filter((a) => a.id === i)[0].name;
function Zo(i) {
  const { file: e, toggleFileCard: t, i18n: r, metaFields: a } = i, { missingRequiredMetaFields: o } = e;
  if (!o?.length)
    return null;
  const s = o.map((n) => Kd(n, a)).join(", ");
...
}, Jd = (i) => i.file.size && u("div", { className: "uppy-Dashboard-Item-statusSize", children: ce(i.file.size) }), eu = (i) => i.file.isGhost && u("span", { children: [" • ", u("button", { className: "uppy-u-reset uppy-c-btn uppy-Dashboard-Item-reSelect", type: "button", onClick: () => i.toggleAddFilesPanel(!0), children: i.i18n("reSelect") })] }), tu = ({ file: i, onClick: e }) => i.error ? u("button", { className: "uppy-u-reset uppy-c-btn uppy-Dashboard-Item-errorDetails", "aria-label": i.error, "data-microtip-position": "bottom", "data-microtip-size": "medium", onClick: e, type: "button", children: "?" }) : null;
function iu(i) {
  ...
  return u("div", { className: "uppy-Dashboard-Item-fileInfo", "data-uppy-file-source": e.source, children: [u("div", { className: "uppy-Dashboard-Item-fileName", children: [Zd({
    file: e,
    isSingleFile: s,
    containerHeight: n,
    containerWidth: p
  }), u(tu, { file: e, onClick: () => alert(e.error) })] }), u("div", { className: "uppy-Dashboard-Item-status", children: [Qd({ file: e }), Jd({ file: e }), eu({ file: e, toggleAddFilesPanel: o, i18n: t })] }), u(Zo, { file: e, i18n: t, toggleFileCard: r, metaFields: a })] });
}
function ru(i) {
...
function yi(i) {
  return u("div", { className: "uppy-Dashboard-Item-progress", children: u("button", { className: "uppy-u-reset uppy-c-btn uppy-Dashboard-Item-progressIndicator", type: "button", "aria-label": Pa(i), title: Pa(i), onClick: () => au(i), children: i.children }) });
}
...
class su extends X {
  ...
  render() {
    ...
    return u("div", { className: l, id: `uppy_${e.id}`, role: this.props.role, children: [u("div", { className: "uppy-Dashboard-Item-preview", children: [u(ru, { file: e, showLinkToFileUploadResult: this.props.showLinkToFileUploadResult, i18n: this.props.i18n, toggleFileCard: this.props.toggleFileCard, metaFields: this.props.metaFields }), u(ou, { uppy: this.props.uppy, file: e, error: s, isUploaded: r, hideRetryButton: this.props.hideRetryButton, hideCancelButton: this.props.hideCancelButton, hidePauseResumeButton: this.props.hidePauseResumeButton, recoveredState: this.props.recoveredState, resumableUploads: this.props.resumableUploads, individualCancellation: this.props.individualCancellation, i18n: this.props.i18n })] }), u("div", { className: "uppy-Dashboard-Item-fileInfoAndButtons", children: [u(iu, { file: e, containerWidth: this.props.containerWidth, containerHeight: this.props.containerHeight, i18n: this.props.i18n, toggleAddFilesPanel: this.props.toggleAddFilesPanel, toggleFileCard: this.props.toggleFileCard, metaFields: this.props.metaFields, isSingleFile: this.props.isSingleFile }), u(Yd, { file: e, metaFields: this.props.metaFields, showLinkToFileUploadResult: this.props.showLinkToFileUploadResult, showRemoveButton: p, canEditFile: this.props.canEditFile, uploadInProgressOrComplete: a, toggleFileCard: this.props.toggleFileCard, openFileEditor: this.props.openFileEditor, uppy: this.props.uppy, i18n: this.props.i18n })] })] });
  }
}
function nu(i, e) {
  const t = [];
...
function lu({ id: i, i18n: e, uppy: t, files: r, resumableUploads: a, hideRetryButton: o, hidePauseResumeButton: s, hideCancelButton: n, showLinkToFileUploadResult: p, showRemoveButtonAfterComplete: l, metaFields: c, isSingleFile: d, toggleFileCard: h, handleRequestThumbnail: m, handleCancelThumbnail: f, recoveredState: y, individualCancellation: b, itemsPerRow: w, openFileEditor: x, canEditFile: _, toggleAddFilesPanel: C, containerWidth: B, containerHeight: g }) {
  const D = w === 1 ? (
    ...
    return y && T.sort(O), nu(T, w);
  }, [r, w, y]), S = (O) => u("div", {
    class: "uppy-Dashboard-filesInner",
    // The `role="presentation` attribute ensures that the list items are properly
    // associated with the `VirtualList` element.
    role: "presentation",
    children: O.map((T) => u(su, {
      uppy: t,
  ...
  return d ? u("div", { class: "uppy-Dashboard-files", children: S(k[0]) }) : u($l, { class: "uppy-Dashboard-files", role: "list", data: k, renderRow: S, rowHeight: D });
}
function pu({ activePickerPanel: i, className: e, hideAllPanels: t, i18n: r, state: a, uppy: o }) {
  const s = Ft(null);
...
function uu({ files: i, i18n: e, isAllComplete: t, isAllErrored: r, isAllPaused: a, inProgressNotPausedFiles: o, newFiles: s, processingFiles: n }) {
  switch (du(r, t, a, i)) {
    case "uploading":
...
function hu(i) {
  ...
  return (
    ...
    u("div", { className: o, "data-uppy-theme": i.theme, "data-uppy-num-acquirers": i.acquirers.length, "data-uppy-drag-drop-supported": !i.disableLocalFiles && Ed(), "aria-hidden": i.inline ? "false" : i.isHidden, "aria-disabled": i.disabled, "aria-label": i.inline ? i.i18n("dashboardTitle") : i.i18n("dashboardWindowTitle"), onPaste: i.handlePaste, onDragOver: i.handleDragOver, onDragLeave: i.handleDragLeave, onDrop: i.handleDrop, children: [u("div", { "aria-hidden": "true", className: "uppy-Dashboard-overlay", tabIndex: -1, onClick: i.handleClickOutside }), u("div", { className: "uppy-Dashboard-inner", role: i.inline ? void 0 : "dialog", style: {
      width: i.inline && i.width ? i.width : "",
      height: i.inline && i.height ? i.height : ""
    }, children: [i.inline ? null : u("button", { className: "uppy-u-reset uppy-Dashboard-close", type: "button", "aria-label": i.i18n("closeModal"), title: i.i18n("closeModal"), onClick: i.closeModal, children: u("span", { "aria-hidden": "true", children: "×" }) }), u("div", { className: "uppy-Dashboard-innerWrap", children: [u("div", { className: "uppy-Dashboard-dropFilesHereHint", children: i.i18n("dropHint") }), n && u(cu, { ...i }), p && u("div", { className: "uppy-Dashboard-serviceMsg", children: [u("svg", { className: "uppy-Dashboard-serviceMsg-icon", "aria-hidden": "true", focusable: "false", width: "21", height: "16", viewBox: "0 0 24 19", children: u("g", { transform: "translate(0 -1)", fill: "none", fillRule: "evenodd", children: [u("path", { d: "M12.857 1.43l10.234 17.056A1 1 0 0122.234 20H1.766a1 1 0 01-.857-1.514L11.143 1.429a1 1 0 011.714 0z", fill: "#FFD300" }), u("path", { fill: "#000", d: "M11 6h2l-.3 8h-1.4z" }), u("circle", { fill: "#000", cx: "12", cy: "17", r: "1" })] }) }), u("strong", { className: "uppy-Dashboard-serviceMsg-title", children: i.i18n("sessionRestored") }), u("div", { className: "uppy-Dashboard-serviceMsg-text", children: c() })] }), n ? u(lu, { id: i.id, i18n: i.i18n, uppy: i.uppy, files: i.files, resumableUploads: i.resumableUploads, hideRetryButton: i.hideRetryButton, hidePauseResumeButton: i.hidePauseResumeButton, hideCancelButton: i.hideCancelButton, showLinkToFileUploadResult: i.showLinkToFileUploadResult, showRemoveButtonAfterComplete: i.showRemoveButtonAfterComplete, metaFields: i.metaFields, toggleFileCard: i.toggleFileCard, handleRequestThumbnail: i.handleRequestThumbnail, handleCancelThumbnail: i.handleCancelThumbnail, recoveredState: i.recoveredState, individualCancellation: i.individualCancellation, openFileEditor: i.openFileEditor, canEditFile: i.canEditFile, toggleAddFilesPanel: i.toggleAddFilesPanel, isSingleFile: t, itemsPerRow: s, containerWidth: i.containerWidth, containerHeight: i.containerHeight }) : u(Xo, { i18n: i.i18n, i18nArray: i.i18nArray, acquirers: i.acquirers, handleInputChange: i.handleInputChange, maxNumberOfFiles: i.maxNumberOfFiles, allowedFileTypes: i.allowedFileTypes, showNativePhotoCameraButton: i.showNativePhotoCameraButton, showNativeVideoCameraButton: i.showNativeVideoCameraButton, nativeCameraFacingMode: i.nativeCameraFacingMode, showPanel: i.showPanel, activePickerPanel: i.activePickerPanel, disableLocalFiles: i.disableLocalFiles, fileManagerSelectionType: i.fileManagerSelectionType, note: i.note, proudlyDisplayPoweredByUppy: i.proudlyDisplayPoweredByUppy }), u(kt, { children: i.showAddFilesPanel ? u(Ad, { ...i, isSizeMD: r }, "AddFiles") : null }), u(kt, { children: i.fileCardFor ? u(Hd, { ...i }, "FileCard") : null }), u(kt, { children: i.activePickerPanel ? u(pu, { ...i }, "Picker") : null }), u(kt, { children: i.showFileEditor ? u(Od, { ...i }, "Editor") : null }), u("div", { className: "uppy-Dashboard-progressindicators", children: i.progressindicators.map((h) => i.uppy.getPlugin(h.id).render(i.state)) })] })] })] })
  );
}
const fu = {
  strings: {
...
function es(i, e, t) {
  ...
  vu(r) ? i.shiftKey && o === 0 ? bu(i, a) : !i.shiftKey && o === a.length - 1 && Ta(i, a) : Ta(i, a);
}
function wu(i, e, t) {
  e === null || es(i, e, t);
}
...
class Oa extends ve {
  ...
  constructor(e, t) {
    ...
    super(e, { ..._u, ...t, autoOpen: r }), this.id = this.opts.id || "Dashboard", this.title = "Dashboard", this.type = "orchestrator", this.defaultLocale = fu, this.opts.doneButtonHandler === void 0 && (this.opts.doneButtonHandler = () => {
  ...
  handleKeyDownInModal = (e) => {
    e.keyCode === xu && this.requestCloseModal(), e.keyCode === Ea && es(e, this.getPluginState().activeOverlayType, this.el);
  };
  handleClickOutside = () => {
  ...
  handleDrop = async (e) => {
    ...
    const a = await md(e.dataTransfer, { logDropError: r });
  ...
  handleKeyDownInInline = (e) => {
    e.keyCode === Ea && wu(e, this.getPluginState().activeOverlayType, this.el);
  };
  ...
  render = (e) => {
    ...
    let _;
    return this.opts.theme === "auto" ? _ = a.darkMode ? "dark" : "light" : _ = this.opts.theme, ["files", "folders", "both"].indexOf(this.opts.fileManagerSelectionType) < 0 && (this.opts.fileManagerSelectionType = "files", console.warn(`Unsupported option for "fileManagerSelectionType". Using default of "${this.opts.fileManagerSelectionType}".`)), hu({
      state: e,
      isHidden: t.isHidden,
      files: r,
      newFiles: s,
  ...
  install = () => {
    ...
    o && this.mount(o, this), this.opts.disableStatusBar || this.uppy.use(Sp, {
      id: this.#f(),
      target: this,
      ...this.#c()
    }), this.opts.disableInformer || this.uppy.use(Ml, {
      id: this.#w(),
      target: this,
      ...this.#d()
    }), this.opts.disableThumbnailGenerator || this.uppy.use(cd, {
      id: this.#m(),
      ...this.#u()
...
var Na = is.exports, Iu = function(e) {
  ...
  */
   ...
   */
  error: null
}, Fu = typeof window < "u" && typeof window.document < "u", we = Fu ? window : {}, Rt = function(e) {
  return e > 0 && e < 1 / 0;
}, Tu = Array.prototype.slice;
function or(i) {
  return Array.from ? Array.from(i) : Tu.call(i);
}
var Eu = /^image\/.+$/;
function Ai(i) {
  return Eu.test(i);
...
function $a(i, e) {
  ...
  return "data:".concat(e, ";base64,").concat(Mu(t.join("")));
}
function zu(i) {
...
function La(i) {
  ...
  return Nu.test(i) ? Math.round(i * e) / e : i;
}
function Ve(i) {
...
var Lu = we.ArrayBuffer, wi = we.FileReader, Se = we.URL || we.webkitURL, ju = /\.\w+$/, Hu = we.Compressor, qu = /* @__PURE__ */ function() {
  function i(e, t) {
    Su(this, i), this.file = e, this.exif = [], this.image = new Image(), this.options = St(St({}, Ua), t), this.aborted = !1, this.result = null, this.init();
  }
  return Pu(i, [{
    key: "init",
    value: function() {
      ...
      Lu || (a.checkOrientation = !1, a.retainExif = !1);
      ...
      if (Se && !n && !p)
        ...
        this.reader = l, l.onload = function(c) {
          ...
          n && (f = zu(h), f > 1 && zt(m, Ru(f))), p && (t.exif = Uu(h)), n || p ? !Se || f > 1 ? m.url = $a(h, o) : m.url = Se.createObjectURL(r) : m.url = h, t.load(m);
        }, l.onabort = function() {
      ...
      if (fr && (hr = "#fff"), b.fillStyle = hr, b.fillRect(0, 0, k, S), f.beforeDraw && f.beforeDraw.call(this, b, y), !this.aborted && (b.save(), b.translate(k / 2, S / 2), b.rotate(n * Math.PI / 180), b.scale(l, d), b.drawImage.apply(b, [m].concat(fe)), b.restore(), f.drew && f.drew.call(this, b, y), !this.aborted)) {
        var mr = function(je) {
          if (!r.aborted) {
            ...
            if (je && fr && f.retainExif && r.exif && r.exif.length > 0) {
              var yr = function(He) {
                return gr(Na($a($u(He, r.exif), f.mimeType)));
              };
              if (je.arrayBuffer)
                je.arrayBuffer().then(yr).catch(function() {
    ...
    value: function(t) {
      ...
      if (Se && n.src.indexOf("blob:") === 0 && Se.revokeObjectURL(n.src), o)
        if (p.strict && !p.retainExif && o.size > s.size && p.mimeType === s.type && !(p.width > r || p.height > a || p.minWidth > r || p.minHeight > a || p.maxWidth < r || p.maxHeight < a))
          ...
          o.lastModified = l.getTime(), o.lastModifiedDate = l, o.name = s.name, o.name && o.type !== s.type && (o.name = o.name.replace(ju, Au(o.type)));
        }
      else
        o = s;
...
class Gu extends lo {
  #e;
  constructor(e, t) {
    super(e, { ...Vu, ...t }), this.id = this.opts.id || "Compressor", this.type = "modifier", this.defaultLocale = Wu, this.#e = new ku(this.opts.limit), this.i18nInit(), this.prepareUpload = this.prepareUpload.bind(this), this.compress = this.compress.bind(this);
  }
  compress(e) {
...
const Xu = "@uppy/image-editor", Yu = "Image editor and cropping UI", Ku = "3.4.1", Zu = "MIT", Qu = "lib/index.js", Ju = "dist/style.min.css", ec = "module", tc = { build: "tsc --build tsconfig.build.json", "build:css": "sass --load-path=../../ src/style.scss dist/style.css && postcss dist/style.css -u cssnano -o dist/style.min.css", typecheck: "tsc --build" }, ic = ["file uploader", "upload", "uppy", "uppy-plugin", "image editor", "cropper", "crop", "rotate", "resize"], rc = "https://uppy.io", ac = { url: "https://github.com/transloadit/uppy/issues" }, oc = { type: "git", url: "git+https://github.com/transloadit/uppy.git" }, sc = { "@uppy/utils": "^6.2.1", cropperjs: "^1.6.2", preact: "^10.5.13" }, nc = { "@uppy/core": "^4.5.1" }, lc = { access: "public" }, pc = { cssnano: "^7.0.7", postcss: "^8.5.6", "postcss-cli": "^11.0.1", sass: "^1.89.2", typescript: "^5.8.3" }, dc = {
  name: Xu,
  description: Yu,
  version: Ku,
  license: Zu,
...
function hc(i, e, t) {
  return Ha(i.prototype, e), Ha(i, t), Object.defineProperty(i, "prototype", {
    writable: !1
  }), i;
}
function fc(i, e, t) {
...
var Ut = typeof window < "u" && typeof window.document < "u", de = Ut ? window : {}, sr = Ut && de.document.documentElement ? "ontouchstart" in de.document.documentElement : !1, nr = Ut ? "PointerEvent" in de : !1, R = "cropper", lr = "all", ns = "crop", ls = "move", ps = "zoom", Pe = "e", Ce = "w", Ae = "s", me = "n", Ge = "ne", Xe = "nw", Ye = "se", Ke = "sw", zi = "".concat(R, "-crop"), qa = "".concat(R, "-disabled"), K = "".concat(R, "-hidden"), Wa = "".concat(R, "-hide"), vc = "".concat(R, "-invisible"), Nt = "".concat(R, "-modal"), Ri = "".concat(R, "-move"), nt = "".concat(R, "Action"), Pt = "".concat(R, "Preview"), pr = "crop", ds = "move", us = "none", Ni = "crop", Ui = "cropend", $i = "cropmove", Li = "cropstart", Va = "dblclick", wc = sr ? "touchstart" : "mousedown", xc = sr ? "touchmove" : "mousemove", _c = sr ? "touchend touchcancel" : "mouseup", Ga = nr ? "pointerdown" : wc, Xa = nr ? "pointermove" : xc, Ya = nr ? "pointerup pointercancel" : _c, Ka = "ready", Za = "resize", Qa = "wheel", ji = "zoom", Ja = "image/jpeg", Dc = /^e|w|s|n|se|sw|ne|nw|all|crop|move|zoom$/, kc = /^data:/, Sc = /^data:image\/jpeg;base64,/, Pc = /^img|canvas$/i, cs = 200, hs = 100, eo = {
  ...
  crop: null,
  zoom: null
}, Cc = '<div class="cropper-container" touch-action="none"><div class="cropper-wrap-box"><div class="cropper-canvas"></div></div><div class="cropper-drag-box"></div><div class="cropper-crop-box"><span class="cropper-view-box"></span><span class="cropper-dashed dashed-h"></span><span class="cropper-dashed dashed-v"></span><span class="cropper-center"></span><span class="cropper-face"></span><span class="cropper-line line-e" data-cropper-action="e"></span><span class="cropper-line line-n" data-cropper-action="n"></span><span class="cropper-line line-w" data-cropper-action="w"></span><span class="cropper-line line-s" data-cropper-action="s"></span><span class="cropper-point point-e" data-cropper-action="e"></span><span class="cropper-point point-n" data-cropper-action="n"></span><span class="cropper-point point-w" data-cropper-action="w"></span><span class="cropper-point point-s" data-cropper-action="s"></span><span class="cropper-point point-ne" data-cropper-action="ne"></span><span class="cropper-point point-nw" data-cropper-action="nw"></span><span class="cropper-point point-sw" data-cropper-action="sw"></span><span class="cropper-point point-se" data-cropper-action="se"></span></div></div>', Bc = Number.isNaN || de.isNaN;
function I(i) {
  return typeof i == "number" && !Bc(i);
}
var to = function(e) {
  return e > 0 && e < 1 / 0;
};
...
function Me(i) {
  ...
  try {
    ...
    return e && t && Ic.call(t, "isPrototypeOf");
  } catch {
    return !1;
  }
}
...
function fs(i) {
  return Array.from ? Array.from(i) : Fc.call(i);
}
function j(i, e) {
...
function Re(i) {
  var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1e11;
  return Tc.test(i) ? Math.round(i * e) / e : i;
}
var Ec = /^width|height|left|top|marginLeft|marginTop$/;
function ye(i, e) {
  var t = i.style;
  j(e, function(r, a) {
    Ec.test(a) && I(r) && (r = "".concat(r, "px")), t[a] = r;
  });
}
function Ac(i, e) {
...
var Oc = /([a-z\d])([A-Z])/g;
function dr(i) {
  return i.replace(Oc, "$1-$2").toLowerCase();
}
function Hi(i, e) {
...
function Rc(i) {
  var e = as({}, i), t = 0;
  return j(i, function(r, a) {
    delete e[a], j(e, function(o) {
...
var jc = /^data:.*,/;
function Hc(i) {
  var e = i.replace(jc, ""), t = atob(e), r = new ArrayBuffer(t.length), a = new Uint8Array(r);
  return j(a, function(o, s) {
    a[s] = t.charCodeAt(s);
  }), r;
}
function qc(i, e) {
...
var Gc = {
  ...
  initPreview: function() {
    ...
    if (t && (s.crossOrigin = t), s.src = a, s.alt = o, this.viewBox.appendChild(s), this.viewBoxImage = s, !!r) {
      var n = r;
      typeof r == "string" ? n = e.ownerDocument.querySelectorAll(r) : r.querySelector && (n = [r]), this.previews = n, j(n, function(p) {
  ...
  preview: function() {
    ...
    !this.cropped || this.disabled || (ye(this.viewBoxImage, N({
      ...
      translateX: -p,
      translateY: -l
    }, e)))), j(this.previews, function(c) {
      var d = Hi(c, Pt), h = d.width, m = d.height, f = h, y = m, b = 1;
  ...
  bind: function() {
    ...
    Y(t.cropstart) && Z(e, Li, t.cropstart), Y(t.cropmove) && Z(e, $i, t.cropmove), Y(t.cropend) && Z(e, Ui, t.cropend), Y(t.crop) && Z(e, Ni, t.crop), Y(t.zoom) && Z(e, ji, t.zoom), Z(r, Ga, this.onCropStart = this.cropStart.bind(this)), t.zoomable && t.zoomOnWheel && Z(r, Qa, this.onWheel = this.wheel.bind(this), {
      passive: !1,
      capture: !0
  ...
  unbind: function() {
    var e = this.element, t = this.options, r = this.cropper;
    Y(t.cropstart) && Q(e, Li, t.cropstart), Y(t.cropmove) && Q(e, $i, t.cropmove), Y(t.cropend) && Q(e, Ui, t.cropend), Y(t.crop) && Q(e, Ni, t.crop), Y(t.zoom) && Q(e, ji, t.zoom), Q(r, Ga, this.onCropStart), t.zoomable && t.zoomOnWheel && Q(r, Qa, this.onWheel, {
      passive: !1,
      capture: !0
  ...
  resize: function() {
    if (!this.disabled) {
      ...
      if (s !== 1) {
        var n, p;
        e.restore && (n = this.getCanvasData(), p = this.getCropBoxData()), this.render(), e.restore && (this.setCanvasData(j(n, function(l, c) {
          n[c] = l * s;
        })), this.setCropBoxData(j(p, function(l, c) {
          p[c] = l * s;
        })));
      }
    }
  ...
  dblclick: function() {
    this.disabled || this.options.dragMode === us || this.setDragMode(Ac(this.dragBox, zi) ? ds : pr);
  },
  wheel: function(e) {
  ...
  cropStart: function(e) {
    ...
    (I(t) && t !== 1 || I(r) && r !== 0 || e.ctrlKey))) {
      ...
      e.changedTouches ? j(e.changedTouches, function(n) {
        o[n.identifier] = Ct(n);
      }) : o[e.pointerId || 0] = Ct(e), Object.keys(o).length > 1 && a.zoomable && a.zoomOnTouch ? s = ps : s = Hi(e.target, nt), Dc.test(s) && Ne(this.element, Li, {
        originalEvent: e,
        action: s
  ...
  cropMove: function(e) {
    ...
    if (!(this.disabled || !t)) {
      ...
      e.preventDefault(), Ne(this.element, $i, {
        originalEvent: e,
        action: t
      }) !== !1 && (e.changedTouches ? j(e.changedTouches, function(a) {
  ...
  cropEnd: function(e) {
    if (!this.disabled) {
      ...
      e.changedTouches ? j(e.changedTouches, function(a) {
  ...
  change: function(e) {
    ...
    _ && (o.width = d, o.height = h, o.left = l, o.top = c, this.action = n, this.renderCropBox()), j(s, function(k) {
  ...
  replace: function(e) {
    ...
    return !this.disabled && e && (this.isImg && (this.element.src = e), t ? (this.url = e, this.image.src = e, this.ready && (this.viewBoxImage.src = e, j(this.previews, function(r) {
  ...
  zoomTo: function(e, t, r) {
    ...
    if (e = Number(e), e >= 0 && this.ready && !this.disabled && a.zoomable) {
      ...
      if (Ne(this.element, ji, {
        ...
        return this;
      if (r) {
        var h = this.pointers, m = ys(this.cropper), f = h && Object.keys(h).length ? Nc(h) : {
          pageX: r.pageX,
          pageY: r.pageY
        };
  ...
  getCroppedCanvas: function() {
    ...
    if (!this.ready || !window.HTMLCanvasElement)
      return null;
    var t = this.canvasData, r = $c(this.image, this.imageData, t, e);
    if (!this.cropped)
      return r;
...
}, Jc = de.Cropper, vs = /* @__PURE__ */ function() {
  function i(e) {
    var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    if (cc(this, i), !e || !Pc.test(e.tagName))
  ...
  return hc(i, [{
    ...
    value: function(t) {
      ...
      if (t) {
        ...
        if (kc.test(t)) {
          Sc.test(t) ? this.read(Hc(t)) : this.clone();
          return;
        }
    ...
    key: "read",
    value: function(t) {
      var r = this.options, a = this.imageData, o = Wc(t), s = 0, n = 1, p = 1;
      if (o > 1) {
        this.url = qc(t, Ja);
        var l = Vc(o);
...
N(vs.prototype, Gc, Xc, Yc, Kc, Zc, Qc);
function eh(i, e) {
...
class oh extends X {
  ...
  onRotate90Deg = () => {
    ...
    const r = this.cropper.getCanvasData(), a = this.cropper.getContainerData(), o = eh(a, r);
  ...
  onRotateGranular = (e) => {
    ...
    const o = this.cropper.getImageData(), s = ih(o.naturalWidth, o.naturalHeight, t), n = this.cropper.getImageData().scaleX < 0 ? -s : s;
...
class lh extends ve {
  ...
  constructor(e, t) {
    ...
    }), this.id = this.opts.id || "ImageEditor", this.title = "Image Editor", this.type = "editor", this.defaultLocale = sh, this.i18nInit();
  }
  canEditFile(e) {
...
*/.cropper-container{direction:ltr;font-size:0;line-height:0;position:relative;-ms-touch-action:none;touch-action:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.cropper-container img{display:block;height:100%;image-orientation:0deg;max-height:none!important;max-width:none!important;min-height:0!important;min-width:0!important;width:100%}.cropper-canvas,.cropper-crop-box,.cropper-drag-box,.cropper-modal,.cropper-wrap-box{inset:0;position:absolute}.cropper-canvas,.cropper-wrap-box{overflow:hidden}.cropper-drag-box{background-color:#fff;opacity:0}.cropper-modal{background-color:#000;opacity:.5}.cropper-view-box{display:block;height:100%;outline:1px solid #39f;outline-color:#3399ffbf;overflow:hidden;width:100%}.cropper-dashed{border:0 dashed #eee;display:block;opacity:.5;position:absolute}.cropper-dashed.dashed-h{border-bottom-width:1px;border-top-width:1px;height:33.3333333333%;left:0;top:33.3333333333%;width:100%}.cropper-dashed.dashed-v{border-left-width:1px;border-right-width:1px;height:100%;left:33.3333333333%;top:0;width:33.3333333333%}.cropper-center{display:block;height:0;left:50%;opacity:.75;position:absolute;top:50%;width:0}.cropper-center:after,.cropper-center:before{background-color:#eee;content:" ";display:block;position:absolute}.cropper-center:before{height:1px;left:-3px;top:0;width:7px}.cropper-center:after{height:7px;left:0;top:-3px;width:1px}.cropper-face,.cropper-line,.cropper-point{display:block;height:100%;opacity:.1;position:absolute;width:100%}.cropper-face{background-color:#fff;left:0;top:0}.cropper-line{background-color:#39f}.cropper-line.line-e{cursor:ew-resize;right:-3px;top:0;width:5px}.cropper-line.line-n{cursor:ns-resize;height:5px;left:0;top:-3px}.cropper-line.line-w{cursor:ew-resize;left:-3px;top:0;width:5px}.cropper-line.line-s{bottom:-3px;cursor:ns-resize;height:5px;left:0}.cropper-point{background-color:#39f;height:5px;opacity:.75;width:5px}.cropper-point.point-e{cursor:ew-resize;margin-top:-3px;right:-3px;top:50%}.cropper-point.point-n{cursor:ns-resize;left:50%;margin-left:-3px;top:-3px}.cropper-point.point-w{cursor:ew-resize;left:-3px;margin-top:-3px;top:50%}.cropper-point.point-s{bottom:-3px;cursor:s-resize;left:50%;margin-left:-3px}.cropper-point.point-ne{cursor:nesw-resize;right:-3px;top:-3px}.cropper-point.point-nw{cursor:nwse-resize;left:-3px;top:-3px}.cropper-point.point-sw{bottom:-3px;cursor:nesw-resize;left:-3px}.cropper-point.point-se{bottom:-3px;cursor:nwse-resize;height:20px;opacity:1;right:-3px;width:20px}@media (min-width:768px){.cropper-point.point-se{height:15px;width:15px}}@media (min-width:992px){.cropper-point.point-se{height:10px;width:10px}}@media (min-width:1200px){.cropper-point.point-se{height:5px;opacity:.75;width:5px}}.cropper-point.point-se:before{background-color:#39f;bottom:-50%;content:" ";display:block;height:200%;opacity:0;position:absolute;right:-50%;width:200%}.cropper-invisible{opacity:0}.cropper-bg{background-image:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA3NCSVQICAjb4U/gAAAABlBMVEXMzMz////TjRV2AAAACXBIWXMAAArrAAAK6wGCiw1aAAAAHHRFWHRTb2Z0d2FyZQBBZG9iZSBGaXJld29ya3MgQ1M26LyyjAAAABFJREFUCJlj+M/AgBVhF/0PAH6/D/HkDxOGAAAAAElFTkSuQmCC)}.cropper-hide{display:block;height:0;position:absolute;width:0}.cropper-hidden{display:none!important}.cropper-move{cursor:move}.cropper-crop{cursor:crosshair}.cropper-disabled .cropper-drag-box,.cropper-disabled .cropper-face,.cropper-disabled .cropper-line,.cropper-disabled .cropper-point{cursor:not-allowed}.uppy-ImageCropper{display:flex;flex-direction:column;height:100%;width:100%}.uppy-ImageCropper-container{flex-grow:1}.uppy-ImageCropper-image{display:block;max-height:400px;max-width:100%}.uppy-ImageCropper-controls{align-items:center;background-color:#0009;border-radius:5px;bottom:15px;color:#fff;display:flex;justify-content:center;left:50%;padding-top:38px;position:absolute;transform:translate(-50%)}.uppy-size--md .uppy-ImageCropper-controls{padding-top:0}.uppy-ImageCropper-controls button{border-radius:5px;height:35px;width:35px}.uppy-ImageCropper-controls button svg{padding:3px}.uppy-size--md .uppy-ImageCropper-controls button{height:40px;width:40px}.uppy-size--md .uppy-ImageCropper-controls button svg{padding:1px}.uppy-ImageCropper-controls button:hover{background-color:#ffffff80}.uppy-ImageCropper-controls button:focus{background-color:#ffffff80;outline:none}.uppy-Dashboard:not(.uppy-size--md) .uppy-ImageCropper-rangeWrapper{height:38px;left:10px;position:absolute!important;right:10px;top:0}.uppy-size--md .uppy-ImageCropper-range{margin-left:5px;margin-right:5px;width:180px}.uppy-ImageCropper .cropper-point{height:8px;width:8px}.uppy-ImageCropper .cropper-view-box{background:repeating-conic-gradient(#bdbdbd33 0 25%,#fff 0 50%) 50%/16px 16px;outline:2px solid #39f}[data-uppy-theme=dark] .uppy-ImageCropper .cropper-view-box{background:repeating-conic-gradient(#2b2a2a 0 25%,#000 0 50%) 50%/16px 16px}.uppy-ImageCropper .cropper-modal{background-color:#fff;opacity:.9}[data-uppy-theme=dark] .uppy-ImageCropper .cropper-modal{background-color:#000;opacity:.7}.uppy-ImageCropper .cropper-face{opacity:0}.uppy-ImageCropper-range::-moz-range-track{height:4px}.uppy-ImageCropper-range:focus::-webkit-slider-runnable-track,.uppy-ImageCropper-range:hover::-webkit-slider-runnable-track{background:#ffffff80}.uppy-ImageCropper-range:focus::-ms-fill-lower,.uppy-ImageCropper-range:focus::-ms-fill-upper,.uppy-ImageCropper-range:hover::-ms-fill-lower,.uppy-ImageCropper-range:hover::-ms-fill-upper{background:#ffffff80}.uppy-ImageCropper-range:focus::-moz-range-track,.uppy-ImageCropper-range:hover::-moz-range-track{background:#ffffff80}`, v = {
  ...
  upload: {
    request: null,
    security: null,
    uriUploadForm: yh("https://authorapi.learnosity.com/latest-lts/assets/uploadform")
  },
  uppy: null
};
function ch(i, e, t = {}) {
  v.renderedCss || wh(), v.upload.security = i, v.upload.request = e, bh(t), vh() && Ps().on("widgetedit:widget:ready", hh);
}
function hh() {
  ...
  const i = (e) => {
    for (const t of e)
      if (t.type === "childList") {
        ...
        if (r && !a) {
          U.debug(`${v.logPrefix}Disconnecting observer`), ao(), fh();
          break;
        }
      }
  };
...
function fh() {
  ...
  setTimeout(() => {
    ...
    s.setAttribute("id", "uppy-dashboard"), a.setAttribute("hidden", ""), r.insertAdjacentElement("afterbegin", s), gh(), ur(), o.removeAttribute("hidden"), mh();
  }, !i && !e ? 0 : 500);
}
function mh() {
  v.uppy = new Qi({
  ...
  }).use(lh, { target: Oa }), v.uppy.on("file-added", (i) => {
...
function wh() {
  const i = document.createElement("style"), e = [ph, dh, uh].join(`
`), t = `
