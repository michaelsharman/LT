import { u as g, v as b, w as k, c as s, o as a, x as w, m as v, j as h, y as u } from "./app-DrpANbC0.js";
import { a as q } from "./index-DE-E8q8p.js";
import { c as E } from "./moduleFactory-Ck7axszi.js";
...
function T() {
  if (g()) {
    _.warn("Telemetry extension is not supported in vertical layout.");
    return;
  }
  N(), r.initialised || (t({
    type: "test:start",
  ...
  s().on("item:load", () => {
    v().forEach((i) => {
      ...
      ["audio", "video"].includes(d) && (p.on("recording:started", () => {
        ...
        const l = c[i] || 0, { revision: y, value: f } = h(i);
