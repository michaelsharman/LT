import { c as P } from "./app-DV5bcV_K.js";
...
function Z(c) {
  p._initialised ? U.debug("Magnifier already initialised, ignoring run();", W) : (c || (c = {
    zoom: 4,
    shape: "square",
    width: 350,
    height: 350
  }), p.magnifier = new F(c), p._initialised = !0);
}
...
function J() {
  const o = items.itemElement().querySelectorAll("img");
  o && o.forEach((h) => {
