import { c as u, f as m } from "./app-nM0lhDJq.js";
...
function y(t = "upperAlpha", r = ".", n) {
  e.prefixMask.hasOwnProperty(t) && (e.chosenMask = t), r && typeof r == "string" && (e.suffix = r), n && Array.isArray(n) && (e.explicitPrefixes = n), e.renderedCss || (h(), e.renderedCss = !0), u().on("item:changed", () => {
    g(m());
  });
}
function g(t) {
