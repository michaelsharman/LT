...
import { v as p, g as v } from "./index-5A9l2Q5l.js";
const o = {
  events: {
    keydownRegistered: !1
  },
...
function f(n) {
  o.options = p(n), o.renderedCss || (w(), o.renderedCss = !0), document.querySelector(".lrn-author").classList.add("lt__contenttabs"), c().on("widgetedit:editor:ready", () => {
    document.removeEventListener("keydown", u), o.events.keydownRegistered = !1;
...
function _() {
  ...
  }), o.events.keydownRegistered || (document.addEventListener("keydown", u), o.events.keydownRegistered = !0));
}
function u(n) {
...
function w() {
  const n = document.createElement("style"), e = v(o.options.theme).concat(
    `
`,
