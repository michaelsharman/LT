import { a as c } from "./app-BFYad37a.js";
import { a as u } from "./index-Ddp_dPeP.js";
...
function f(n) {
  l.options = u.validateOptions(n), l.renderedCss || (w(), l.renderedCss = !0), document.querySelector(".lrn-author").classList.add("lt__contenttabs"), c().on("widgetedit:editor:ready", () => {
    document.removeEventListener("keydown", p), l.events.keydownRegistered = !1;
...
function m(n, e) {
                        ...
                        <div class="lrn-qe-modal-content" data-lrn-qe-modal-section="content">
                            <div class="lrn-qe-edit-aria-label">
                                <div class="lrn-qe-form-group-wrapper">
                                    ...
                                    <input class="lrn-qe-input lrn-qe-form-control" type="number" id="numtabs" value="2" min="1" max="${l.options.maxTabs}" required>
                                </div>
                            </div>
                        </div>
  ...
  const o = [];
  o.push(document.querySelector("#lt__addTabs .lrn-qe-btn-default")), o.push(document.querySelector("#lt__addTabs .lrn-qe-modal-btn-close"));
  for (let a = 0; a < o.length; a++)
    o[a].addEventListener("click", () => (b("lt__addTabs"), e("")));
...
function _() {
  document.querySelectorAll(".lrn-qe-col-edit-inner .lt__nav-tabs li a").forEach((e) => {
    e.setAttribute("title", ""), e.setAttribute("contenteditable", "false"), e.addEventListener("focus", (t) => t.target.blur()), e.addEventListener("dblclick", (t) => {
      t.preventDefault();
      const o = window.prompt("Edit tab label:", e.textContent);
  ...
  }), l.events.keydownRegistered || (document.addEventListener("keydown", p), l.events.keydownRegistered = !0));
}
function p(n) {
  if (n.key === "Backspace" && !!q()?.querySelector(".lt__tabs")) {
    const t = document.querySelector(".lrn-qe-col-edit-inner .lt__tab-content"), o = g(), s = t.querySelector(".lt__tab-pane.active");
    if (o === 0) {
      const a = window.getSelection();
      if (!(!a.isCollapsed && a.toString().length > 0) && (n.preventDefault(), s.firstChild)) {
...
function g() {
  ...
  for (; t && t.previousSibling; )
    t = t.previousSibling, o += t.textContent.length;
  return o;
}
function q() {
  const n = window.getSelection();
...
function h(n) {
  let e = '<div class="tabs lt__tabs"><ul class="nav nav-tabs lt__nav-tabs" role="tablist">', t = ' class="active"', o = " active";
  const s = "_" + y();
  for (let a = 1; a <= n; a++)
    e += `<li role="presentation"${t} aria-controls="${a}${s}"><a role="tab" data-tab-target="[data-tab-id='${a}${s}']" data-toggle="tab" href="#">Tab ${a}</a></li>`, a === 1 && (t = "");
  e += '</ul><div class="tab-content lt__tab-content">';
  for (let a = 1; a <= n; a++)
    e += `<div class="tab-pane lt__tab-pane${o}" data-tab-id="${a}${s}" id="${a}${s}"><p>Tab ${a} content</p></div>`, a === 1 && (o = "");
  return e += "</div></div>", e;
}
function y() {
...
function w() {
  const n = document.createElement("style"), e = u.getTabsTheme(l.options.theme).concat(
    `
`,
  ...
  n.setAttribute("data-style", "LT Content Tabs"), n.textContent = e, document.head.append(n), l.renderedCss = !0;
}
const T = v("contentTabs", f, {
  addContentTabs: m
