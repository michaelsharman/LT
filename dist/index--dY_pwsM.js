...
import { f as u } from "./app-DV5bcV_K.js";
const e = {
...
function y(t = "upperAlpha", r = ".", n) {
  e.prefixMask.hasOwnProperty(t) && (e.chosenMask = t), r && typeof r == "string" && (e.suffix = r), n && Array.isArray(n) && (e.explicitPrefixes = n), e.renderedCss || g(), app.appInstance().on("item:changed", () => {
    m(u());
  });
}
function m(t) {
  ...
  try {
    for (const i of t)
      if (i.type === "mcq" && i?.ui_style?.type !== "block" && i?.ui_style?.type !== "horizontal-input-bottom") {
        ...
        app.appInstance().question(p).on("rendered", () => {
