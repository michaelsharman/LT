import { b as j, T as ie, U as X, S as G, R as ae, V as se } from "./app-k__14e_y.js";
...
function me() {
  return U || (U = 1, function(m) {
    (function(a, i, s) {
      ...
      function V(t, r) {
        return t === null || t === i ? !1 : t === r ? !0 : V(t.parentNode, r);
      }
      function b(t) {
        var r = this;
        ...
        r._handleKey = function(n, u, p) {
          ...
          for (h = 0; h < f.length; ++h) {
            if (f[h].seq) {
              if (f[h].level != d)
                continue;
              w = !0, E[f[h].seq] = 1, N(f[h].callback, p, f[h].combo, f[h].seq);
              continue;
            }
            w || N(f[h].callback, p, f[h].combo);
          }
          var T = p.type == "keypress" && q;
          p.type == R && !C(n) && !T && B(E), q = w && p.type == "keydown";
        };
        function W(n) {
        ...
        function te() {
          clearTimeout(v), v = setTimeout(B, 1e3);
        }
        function re(n, u, p, f) {
          c[n] = 0;
          function h(A) {
          ...
          function E(A) {
            N(p, A, n), f !== "keyup" && (S = I(A)), setTimeout(B, 10);
          }
        ...
        function H(n, u, p, f, h) {
          ...
          d = z(n, p), r._callbacks[d.key] = r._callbacks[d.key] || [], $(d.key, d.modifiers, { type: d.action }, f, n, h), r._callbacks[d.key][f ? "unshift" : "push"]({
            callback: u,
