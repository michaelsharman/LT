          ...
          if (f) {
            ...
            for (const c of f) {
              ...
              if (!c.querySelector(".lrn-prefix-label")) {
                let s;
                Array.isArray(e.explicitPrefixes) && e.explicitPrefixes.length && typeof e.explicitPrefixes[l] == "string" ? s = e.explicitPrefixes[l] : s = String.fromCharCode(r + l);
                for (let o = 0; o < x.length; o++) {
                  const a = document.createElement("span");
                  a.classList.add("lrn-prefix-label"), a.append(`${s}${n}`), x[o].prepend(a);
                }
                l++;
              }
            }
