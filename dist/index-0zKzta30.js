import { a as c } from "./app-DSq6w2-y.js";
import { a as u } from "./index-BsABOMI-.js";
import { c as v } from "./moduleFactory-Ck7axszi.js";
const o = {
  events: {
    keydownRegistered: !1
  },
...
function f(n) {
  o.options = u.validateOptions(n), o.renderedCss || (w(), o.renderedCss = !0), document.querySelector(".lrn-author").classList.add("lt__contenttabs"), c().on("widgetedit:editor:ready", () => {
    document.removeEventListener("keydown", p), o.events.keydownRegistered = !1;
                        ...
                        <div class="lrn-qe-modal-content" data-lrn-qe-modal-section="content">
                            <div class="lrn-qe-edit-aria-label">
                                <div class="lrn-qe-form-group-wrapper">
                                    ...
                                    <input class="lrn-qe-input lrn-qe-form-control" type="number" id="numtabs" value="2" min="1" max="${o.options.maxTabs}" required>
                                </div>
                            </div>
                        </div>
...
function _() {
  ...
  }), o.events.keydownRegistered || (document.addEventListener("keydown", p), o.events.keydownRegistered = !0));
}
function p(n) {
  if (n.key === "Backspace" && !!q()?.querySelector(".lt__tabs")) {
    const t = document.querySelector(".lrn-qe-col-edit-inner .lt__tab-content"), l = g(), s = t.querySelector(".lt__tab-pane.active");
    if (l === 0) {
...
function h(n) {
  ...
  for (let a = 1; a <= n; a++)
    e += `<div class="tab-pane lt__tab-pane${l}" data-tab-id="${a}${s}" id="${a}${s}"><p>Tab ${a} content</p></div>`, a === 1 && (l = "");
  return e += "</div></div>", e;
}
function y() {
...
function w() {
  const n = document.createElement("style"), e = u.getTabsTheme(o.options.theme).concat(
    `
`,
  ...
  n.setAttribute("data-style", "LT Content Tabs"), n.textContent = e, document.head.append(n), o.renderedCss = !0;
}
