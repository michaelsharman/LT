import { a, a8 as i, q as d } from "./app-CgKRbBlK.js";
...
function p(e, t) {
  e && typeof e == "string" && (s.label = e), t && Array.isArray(t) && (s.types = t), s.renderedCss || f(), a().on("item:changed", () => {
    u();
  });
}
function u() {
