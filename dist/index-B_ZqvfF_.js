...
function n(r = 60) {
  if (e._initialised)
    ...
    e.elTimer = e.elTimerWrapper.querySelector(".timer"), e.elClock = e.elTimerWrapper.querySelector(".clock"), t && e.elTimerWrapper ? (e.renderedCss || s(), e._initialised = !0, e.elTimerWrapper.querySelector(".timer"), e.elTimerWrapper.classList.add("lt__timer-wrapper", "lrn_btn"), e.elTimerWrapper.setAttribute("role", "button"), e.elTimerWrapper.setAttribute("tabindex", "0"), e.elTimerWrapper.setAttribute("aria-pressed", "true"), e.elTimerWrapper.setAttribute("aria-label", "Assessment time. Timer is visible. Click to hide it."), e.elTimerWrapper.addEventListener("click", o), e.elTimerWrapper.addEventListener("keydown", (i) => {
