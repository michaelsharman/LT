import { c, p } from "./app-CnMVZMul.js";
const a = {
  options: {
...
function u(e) {
  a.options = b(e), a.renderedCss || f(), c().on("item:load", () => {
    const t = p();
    if (!a.visitedItems.has(t)) {
      const r = document.querySelector(`div[data-reference="${t}"]`).querySelectorAll("ul.lt__nav-tabs");
      if (r)
        for (const i of r)
...
function b(e) {
  const t = ["rounded", "api-column-tabs"];
  let o = e || {};
  return e && typeof e == "object" ? (o = { ...a.options, ...e }, t.includes(o.theme) || (o.theme = "api-column-tabs")) : o = { ...a.options }, o;
}
function f() {
  const e = document.createElement("style"), t = "/* Learnosity content tab styles */";
  e.setAttribute("data-style", "LT Content Tabs"), e.textContent = t.concat(`
`, d(a.options.theme)), document.head.append(e), a.renderedCss = !0;
}
function d(e) {
  const t = `/* Base tabs styles */
