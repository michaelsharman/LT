import { c, f as i, k as d } from "./app-VrnQQRdL.js";
...
function p(e, t) {
  e && typeof e == "string" && (s.label = e), t && Array.isArray(t) && (s.types = t), s.renderedCss || f(), c().on("item:changed", () => {
    u();
  });
}
function u() {
      ...
      if (s.types.includes("*") || s.types.includes(t.type)) {
        ...
        c().question(o).on("rendered", () => {
          ...
          if (n) {
            ...
            r || (a.append(m()), r = n.querySelector(`.${s.class}`), r.addEventListener("click", y));
          } else
