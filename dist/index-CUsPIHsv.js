import { c, f as a, k as d } from "./app-DV5bcV_K.js";
...
function u() {
  ...
  try {
    for (const t of e)
      if (console.log(`Checking question type: ${t}`), s.types.includes("*") || s.types.includes(t.type)) {
        ...
        c().question(o).on("rendered", () => {
          ...
          if (n) {
            ...
            r || (i.append(y()), r = n.querySelector(`.${s.class}`), r.addEventListener("click", m));
          } else
