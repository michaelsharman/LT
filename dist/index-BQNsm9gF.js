import { u as g, n as v, c as s, o as i, p as b, r as k, v as o, w, x as d } from "./app-C2_EjRb0.js";
...
function T() {
  ...
  s().on("item:load", () => {
    k().forEach((a) => {
      const u = s().question(a), c = o(a).type;
      ["audio", "video"].includes(c) && (u.on("recording:started", () => {
        t({
...
function x() {
  setTimeout(() => {
    ...
    return console.log("test:panel:show", n), n;
  }, 500);
}
function e() {
  return Date.now();
