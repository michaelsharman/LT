import { a as f, a0 as v } from "./app-CgKRbBlK.js";
const l = {
  renderedCss: !1,
  resize: {
    triggered: !1
...
function h() {
  l.renderedCss || y(), f().on("item:load", () => {
    g();
...
function g() {
  const e = v(), t = e.querySelectorAll('[class^="col-"]'), n = !!e.querySelector(".lrn-resizer"), r = !!document.querySelector(".lrn-layout-single-column");
  if (t.length === 2) {
    if (!r && !n) {
...
function b(e, t) {
  const n = e.querySelector(".lrn-resizer");
  n && n.remove(), t[0].removeAttribute("style"), window.dispatchEvent(new Event("resize"));
}
function x(e) {
  const t = (r) => {
    ...
    const p = (s) => {
      ...
      const u = (m + a) * 100 / r.parentNode.getBoundingClientRect().width;
    ...
    r.addEventListener("mousedown", p), r.addEventListener("touchstart", p);
  }, n = e.querySelector(".lrn-resizer");
  n && t(n);
}
function y() {
...
function z(e, t) {
  ...
  return (...r) => {
    clearTimeout(n), n = setTimeout(() => {
      l.resize.triggered = !1, e.apply(this, r);
    }, t);
  };
}
