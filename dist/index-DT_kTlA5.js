import { L as V } from "./activity-BOoVb08o.js";
import { d as X, h as W } from "./player-BEY6StBo.js";
        ...
        play: function(e, t) {
          ...
          if (n._webAudio) {
            ...
            var O = function() {
              ...
              try {
                var k = g.play();
                if (k && typeof Promise < "u" && (k instanceof Promise || typeof k.then == "function") ? (n._playLock = !0, L(), k.then(function() {
                ...
                })) : t || (n._playLock = !1, L(), n._emit("play", a._id)), g.playbackRate = a._rate, g.paused) {
