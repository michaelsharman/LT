...
import { t as s } from "./widgets-BxvIhqg8.js";
const n = {
  renderedCss: !1,
  validTypes: ["longtextV2", "plaintext"]
};
function l() {
  n.renderedCss || (u(), n.renderedCss = !0), i();
}
function i() {
  a().on("widgetedit:widget:ready", () => {
    setTimeout(() => {
      const e = s();
...
function d(e) {
  const t = /^\d+$/, o = /^(0|[1-9]\d*)$/, r = "lt__input-invalid";
  e.value = e.value.replace(/^0+/, ""), t.test(e.value) || (e.value = e.value.replace(/[^0-9]/g, "")), e.value.length && !o.test(e.value) ? e.classList.add(r) : e.classList.remove(r);
}
function u() {
