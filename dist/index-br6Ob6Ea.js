...
import { c as T } from "./extensionsFactory-DRAOPv5d.js";
...
function x() {
  ...
  e.id = "lt__error-dialog", e.className = "lt__error-dialog", e.innerHTML = `
    ...
    `, t.appendChild(e), r.renderedCss || (E(), r.renderedCss = !0);
}
function b(t, e = !1) {
  x();
  ...
  l.innerHTML = `${r.options.heading.replace("{s}", u)}`, i.innerHTML = `
    ...
    const g = a.getSelectedTags(), m = n().getItemTags(), p = [...m, ...g.filter((_) => !m.some((h) => h.type === _.type && h.name === _.name))], f = v(p);
    if (n().setItemTags(p), !f.valid) {
      b(f.message);
      return;
    }
    e && n().save(), s.close();
...
const q = T("requiredTags", S), B = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  requiredTags: q
