import { c as x, l as b } from "./app-C501rTFe.js";
const a = {
  renderedCss: !1,
  resize: {
    triggered: !1
...
function z() {
  a.renderedCss || S(), x().on("item:load", () => {
    w();
...
function E(e) {
  const n = (i) => {
    ...
    i.addEventListener("mousedown", v), i.addEventListener("touchstart", v), i.addEventListener("keydown", y);
