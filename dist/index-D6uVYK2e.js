import { a as Ps } from "./app-Cp7l631V.js";
import { c as Cs } from "./styling-D3G23PGa.js";
...
function wp(i) {
  ...
  return u("div", { className: "uppy-StatusBar-content", title: b, children: [n ? null : u(Mo, {}), u("div", { className: "uppy-StatusBar-status", children: [u("div", { className: "uppy-StatusBar-statusPrimary", children: t && r !== 0 ? `${b}: ${r}%` : b }), w(), y ? u(vp, { i18n: e, newFiles: p, startUpload: f }) : null] })] });
}
function xp(i) {
  const { i18n: e } = i;
  return u("div", {
...
function kp({ newFiles: i, allowNewUpload: e, isUploadInProgress: t, isAllPaused: r, resumableUploads: a, error: o, hideUploadButton: s = void 0, hidePauseResumeButton: n = !1, hideCancelButton: p = !1, hideRetryButton: l = !1, recoveredState: c, uploadState: d, totalProgress: h, files: m, supportsUploadProgress: f, hideAfterFinish: y = !1, isSomeGhost: b, doneButtonHandler: w = void 0, isUploadStarted: x, i18n: _, startUpload: C, uppy: B, isAllComplete: g, showProgressDetails: D = void 0, numUploads: k, complete: S, totalSize: O, totalETA: T, totalUploadedSize: M }) {
  ...
  const A = F(), V = A ?? 100, oe = !o && i && (!t && !r || c) && e && !s, ue = !p && d !== Dp && d !== bt, he = a && !n && d === yt, xe = o && !g && !l, _e = w && d === bt, Fe = ae("uppy-StatusBar-progress", {
    "is-indeterminate": z()
...
function Yd(i) {
  ...
  u("div", { className: ae("uppy-Dashboard-FileCard", c), "data-uppy-panelType": "FileCard", onDragOver: ge, onDragLeave: ge, onDrop: ge, onPaste: ge, children: [u("div", { className: "uppy-DashboardContent-bar", children: [u("div", {
    ...
    _(D), n(m);
  }, children: p("editImage") })] }), u("div", { className: "uppy-Dashboard-FileCard-info", children: u(Xd, { computedMetaFields: f, requiredMetaFields: s, updateMeta: C, form: g, formState: w }) }), u("div", { className: "uppy-Dashboard-FileCard-actions", children: [u("button", {
...
N(vs.prototype, eh, th, ih, rh, ah, oh);
function nh(i, e) {
...
function vh(i, e, t = {}) {
  v.renderedCss || (Ch(), v.renderedCss = !0), v.upload.security = i, v.upload.request = e, Sh(t), Ph() && Ps().on("widgetedit:widget:ready", wh);
}
function wh() {
  ...
  const i = (e) => {
    for (const t of e)
      if (t.type === "childList") {
        ...
        if (r && !a) {
          U.debug(`${v.logPrefix}Disconnecting observer`), ao(), xh();
          break;
        }
      }
  };
...
function _h() {
  ...
  }).use(mh, { target: Oa }), v.uppy.on("file-added", (i) => {
...
function Ch() {
  const i = document.createElement("style"), e = [gh, yh, bh].join(`
`), t = `
