...
function vh(i, e, t = {}) {
  v.renderedCss || Ch(), v.upload.security = i, v.upload.request = e, Sh(t), Ph() && Ps().on("widgetedit:widget:ready", wh);
}
function wh() {
