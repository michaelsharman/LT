import { c as b, o as p } from "./app-DrpANbC0.js";
...
function f(t) {
  e.options = c(t), e.renderedCss || (m(), e.renderedCss = !0), b().on("item:load", () => {
    const o = p();
...
`, d(e.options.theme)), document.head.append(t), e.renderedCss = !0;
}
function d(t) {
