...
function b(a, o) {
  ...
  for (let n = 0; n < e.length; n++) {
    let t;
    n === 0 && (t = document.createElement("option"), t.value = "", t.text = "--", r.add(t)), t = document.createElement("option"), t.value = e[n].code, t.text = e[n].language, t.setAttribute("data-dir", e[n].direction), r.add(t);
  }
  const c = [];
  ...
  document.querySelector("#ltLanguageModal .lrn-qe-btn-primary").addEventListener("click", () => {
    const n = y(d), t = {};
    document.getElementById("ltLanguageModal").remove(), r.selectedIndex > 0 && (t.direction = r.options[r.selectedIndex].getAttribute("data-dir"), t.code = r.options[r.selectedIndex].value), u.checked && (t.noTranslate = !0);
    const p = q(t, n, d, l);
    return o(p);
  });
}
