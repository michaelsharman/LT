...
import { d as X, h as W } from "./player-Ja5E2l_p.js";
import { c as z } from "./extensionsFactory-DRAOPv5d.js";
import H from "./logger.js";
import { c as S } from "./_commonjsHelpers-DQNKXVTB.js";
var L = {};
/*!
 *  howler.js v2.2.4
 *  howlerjs.com
...
function Q(y, m) {
  v.elementId = y || null, v.queryRoot = m || document, v.renderedCss || (J(), v.renderedCss = !0);
  try {
...
function Y(y) {
  ...
  v.player.sound && E(v.player.sound), r.classList.contains("lt__sound-active") ? E(m) : (v.player.instances[m] || Z(m), v.player.sound = m, j(m)), q(m);
}
function Z(y) {
