import { A as g, B as b, C as k, c as s, y as a, D as v, m as w, j as h, E as u } from "./app-Bg1Xow-5.js";
import { c as q } from "./index-BGoSnTgK.js";
const m = {
  initialised: !1,
  network: "online",
  telemetry: {
...
function E() {
  if (g()) {
    console.warn("Telemetry extension is not supported in vertical layout.");
    return;
  }
  _(), m.initialised || (t({
    type: "test:start",
  ...
  }), T(), N(), O(), L(), m.initialised = !0);
}
function _() {
  m.telemetry.user = b(), m.telemetry.session = k();
}
function T() {
  s().on("unfocused", () => {
    t({
