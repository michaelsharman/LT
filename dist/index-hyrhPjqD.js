import { u as g, n as w, c as s, o as i, p as k, r as b, v as o, w as v, x as c } from "./app-C2_EjRb0.js";
...
function q() {
  ...
  }), E(), T(), O(), N(), n.initialised = !0);
}
function _() {
  n.telemetry.user = g(), n.telemetry.session = w();
}
function E() {
  s().on("unfocused", () => {
    t({
...
function T() {
  ...
  s().on("item:load", () => {
    b().forEach((a) => {
      const p = s().question(a), d = o(a).type;
      ["audio", "video"].includes(d) && (p.on("recording:started", () => {
        ...
        const f = u[a] || 0, { revision: l, value: y } = v(a);
        r.includes(d) ? e() - f >= 3e4 && (u[a] = e(), t({
