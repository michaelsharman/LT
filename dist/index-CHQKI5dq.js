import { c as j, l as U } from "./app-BC_Cj6Pt.js";
import { c as W } from "./extensionsFactory-DRAOPv5d.js";
import Z from "./logger.js";
const G = "ERROR", p = {
  _initialised: !1,
  magnifier: null
};
...
function K(c) {
  ...
  function y() {
    switch (o.options.shape) {
      case "square":
        C(r, o.options.width, o.options.height);
        break;
      case "circle":
        C(r, o.options.width, o.options.height), r.style.borderRadius = "50%";
        break;
    }
  ...
  function B() {
    u && (window.clearTimeout(O), O = window.setTimeout(z, 100));
  }
  function A() {
    u && B();
  }
  ...
  function M() {
    ...
    const v = document.body.clientWidth, S = document.body.clientHeight;
    C(l, v, S), m = l.querySelector("body"), b("contentUpdated", m);
  }
  function I() {
    b("initScrollBars", m);
  }
  ...
  function X(e, t) {
    ...
    function P(s) {
      ...
      if (a && t.exclude.indexOf(a.tagName.toUpperCase()) == -1 && (!f || t.exclude.indexOf(f.tagName.toUpperCase()) == -1)) {
        ...
        _ = n.getBoundingClientRect().left - n.offsetLeft, H = n.getBoundingClientRect().top - n.offsetTop, g = w - (n.getBoundingClientRect().left + document.body.scrollLeft), S = k - (n.getBoundingClientRect().top + document.body.scrollTop), s.preventDefault();
      }
    }
    function V(s) {
      if (n !== null) {
        const a = s.pageX || s.touches[0].pageX, f = s.pageY || s.touches[0].pageY, w = a - g - _ - document.body.scrollLeft, k = f - S - H - document.body.scrollTop;
    ...
    return [
      { target: d, types: ["mousedown", "touchstart"], handler: P },
      { target: window, types: ["mousemove", "touchmove"], handler: V },
      { target: window, types: ["mouseup", "touchend"], handler: Y }
  ...
  function D() {
    ...
    e.innerHTML = h, r = e.querySelector(".magnifier"), document.querySelector(".lrn-assess").appendChild(r), l = r.querySelector(".magnifier-content"), window.addEventListener && (window.addEventListener("resize", z, !1), window.addEventListener("scroll", L, !0)), X(r, {
      ondrag: T
    });
  }
  return o.setZoom = (e) => {
    ...
    $(), l.innerHTML = "", r.style.display = "none", u = !1;
  }, o.show = (e) => {
    let t, i;
    e ? (t = e.pageX - 175, i = e.pageY - 175) : (t = 200, i = 200), y(), M(), q(r, t, i), r.style.display = "", T(), L(), I(), u = !0;
  }, o.toggle = () => {
