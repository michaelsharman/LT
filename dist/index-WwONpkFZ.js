...
function a(t) {
  n.renderedCss || (f(), n.renderedCss = !0), p(t), setInterval(c, n.options.interval);
}
async function c() {
  const t = await i(), e = document.querySelector(".lt__networkStatus-indicator"), { render: r, iconWrapper: o, message: s } = n.options;
  d(t), r && (t ? e && e.remove() : l(e, o, s));
}
function l(t, e, r) {
  if (t)
    return;
...
function d(t) {
  const e = t ? "LTNetworkOnline" : "LTNetworkOffline", r = new CustomEvent(e);
