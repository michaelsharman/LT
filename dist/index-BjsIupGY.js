import { c as j, n as ie, C as G, f as U, l as ae, D as se } from "./app-BC_Cj6Pt.js";
import { a as ce } from "./_commonjsHelpers-DQNKXVTB.js";
import { c as fe } from "./extensionsFactory-DRAOPv5d.js";
function ue(m, a) {
    ...
    (function(i, s) {
      ...
      if (e.gui) {
        ...
        if (window.addEventListener("gamepadconnected", function(o) {
          ...
          e.touch = navigator.maxTouchPoints > 0, e.tv = u.includes("TV"), P = navigator.getGamepads ? Array.from(navigator.getGamepads()).filter(function(o) {
            return o != null;
...
const Pe = fe("keyboardShortcuts", ve), Oe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  keyboardShortcuts: Pe
