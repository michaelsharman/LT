import { u as g, n as v, c as s, o as i, p as w, r as k, v as p, w as b, x as d } from "./app-C2_EjRb0.js";
...
function _() {
  o.telemetry.user = g(), o.telemetry.session = v();
}
function E() {
  s().on("unfocused", () => {
    t({
