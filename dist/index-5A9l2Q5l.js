import { c, y as p } from "./app-nM0lhDJq.js";
const t = {
  options: {
...
function u(e) {
  t.options = d(e), t.renderedCss || (f(), t.renderedCss = !0), c().on("item:load", () => {
    const o = p();
    if (!t.visitedItems.has(o)) {
...
function d(e) {
  ...
  let a = e || {};
  return e && typeof e == "object" ? (a = { ...t.options, ...e }, o.includes(a.theme) || (a.theme = "api-column-tabs")) : a = { ...t.options }, a;
}
function f() {
  const e = document.createElement("style"), o = "/* Learnosity content tab styles */";
  e.setAttribute("data-style", "LT Content Tabs"), e.textContent = o.concat(`
`, b(t.options.theme)), document.head.append(e), t.renderedCss = !0;
}
function b(e) {
