import { a } from "./app-DSq6w2-y.js";
import { c as l } from "./moduleFactory-Ck7axszi.js";
import { d as c } from "./debounce-CqEeJcMa.js";
const i = {
  renderedCss: !1
};
function d() {
  i.renderedCss || (f(), i.renderedCss = !0), setTimeout(() => {
    e();
  }, 1500), a().on("navigate", e);
  function e() {
    setTimeout(() => {
      a().getLocation().route === "items/:reference/settings/:tab" && u();
    }, 300);
  }
}
function u() {
  ...
  e && e.addEventListener("input", c(n, 750));
  function n() {
...
function g(e) {
  ...
  t || e.insertAdjacentHTML("beforeend", `
    ...
    `), n && n.classList.add("hidden"), document.getElementById("lt__createTagsBtn").addEventListener("click", p);
}
function p() {
...
const _ = l("createTags", d), v = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createTags: _
