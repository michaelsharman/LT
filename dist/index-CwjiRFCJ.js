import { c as j, l as U } from "./app-C0Ni2tF_.js";
...
function J(c) {
  ...
  function D() {
    ...
    e.innerHTML = h, r = e.querySelector(".magnifier"), document.querySelector(".lrn-assess").appendChild(r), l = r.querySelector(".magnifier-content"), window.addEventListener && (window.addEventListener("resize", z, !1), window.addEventListener("scroll", L, !0)), $(r, {
      ondrag: T
    });
  }
  return o.setZoom = (e) => {
    ...
    let t, i;
    e ? (t = e.pageX - 175, i = e.pageY - 175) : (t = 200, i = 200), y(), M(), q(r, t, i), r.style.display = "", T(), L(), X(), u = !0;
  }, o.toggle = () => {
